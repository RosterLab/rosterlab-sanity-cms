...
export function createEmployeeCertificatePage(isUS = false) {
...
`;
  const features = [
    {
      ...
      description: isUS
        ? "Customize the certificate with employee names, dates, and personalized messages using Canva's easy-to-use editor."
    ...
    },
    {
      ...
      description: isUS
        ? "Optimized for standard paper sizes and high-quality printing to create an impressive recognition award."
  ...
  const faqItems = [
    {
      ...
      answer: isUS
        ? "This free certificate template is perfect for managers, HR teams, and business owners who want to recognize and celebrate outstanding employee performance. It's ideal for companies of any size looking to boost morale and show appreciation for their team members' hard work."
    ...
    },
    {
      ...
      answer: isUS
        ? "After submitting the form, you'll receive access to the template on Canva. Simply click the button to open it in Canva's editor, where you can easily customize the employee name, date, achievement details, and any other text. No design experience required - Canva makes it simple to personalize your certificates."
  ...
  async function FreeEmployeeOfMonthCertificatePage() {
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                <div>
                  ...
                  <p className="text-xl text-gray-600 mb-8">
                    {isUS ? (
                      <>
                        Recognize outstanding team members with our
                        professionally designed, fully editable Canva
                        certificate template.
                      </>
                    ) : (
                      <>
                        Recognise outstanding team members with our
                        professionally designed, fully editable Canva
                        certificate template.
                      </>
                    )}
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <p className="text-sm text-blue-800">
                      ...
                      Access your editable Canva template instantly.
                    </p>
                  </div>
                </div>

                {/* Form Section - Client Component */}
                <EmployeeOfMonthFormClient isUS={isUS ? true : undefined} />
              </div>
            </Container>
          </div>
            ...
            <Container>
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                  Everything you need to create professional employee
            ...
            <Container>
              <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-3xl p-12 text-center text-white">
                ...
                <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
                  {isUS ? (
                    <>
                      While certificates recognize great work, RosterLab helps
                      create it. Discover how our workforce management platform
                      empowers your team to perform at their best.
                    </>
                  ) : (
                    <>
                      While certificates recognise great work, RosterLab helps
                      create it. Discover how our workforce management platform
                      empowers your team to perform at their best.
                    </>
                  )}
  ...
  return FreeEmployeeOfMonthCertificatePage;
}
