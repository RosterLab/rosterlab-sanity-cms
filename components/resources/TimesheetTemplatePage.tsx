...
export function createTimesheetTemplatePage(isUS = false) {
...
`;
  const features = [
    ...
    },
    {
      ...
      title: isUS ? "Customizable" : "Customisable",
      description:
  ...
  const faqItems = [
    ...
    {
      question: isUS
        ? "Can I customize the timesheet template?"
        : "Can I customise the timesheet template?",
      answer: isUS
          ...
          <div className="py-20">
            <Container>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                <TimesheetFormClient isUS={isUS ? true : undefined} />
              </div>
            </Container>
          </div>
            ...
            <Container>
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                  Everything you need to track employee hours and prepare
                  payroll efficiently
                </p>
              </div>
          ...
          <section className="bg-white py-20">
            <Container>
              <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
                {isUS ? (
                  <>Learn More About Digital Scheduling</>
                ) : (
            ...
            <Container>
              <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-3xl p-12 text-center text-white">
                ...
                <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
                  ...
                  digital solution automates the entire process - from
  ...
  return FreeStaffTimesheetTemplatePage;
}
