...
export default function NewsroomPageContent({
  isUS = false,
  posts,
  currentPage = 1,
}: NewsroomPageContentProps) {
    ...
    <div className="py-16 bg-neutral-50 min-h-screen">
      <Container>
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-neutral-900 mb-4">Newsroom</h1>
        ...
        <div className="max-w-2xl mx-auto mb-12">
          ...
          {searchQuery && (
            <p className="mt-3 text-sm text-neutral-600 text-center">
              ...
              {filteredPosts.length === 1 ? "news post" : "news posts"}
          ...
          <>
            ...
            {!searchQuery && totalPages > 1 && (
              <Pagination
                ...
                basePath={isUS ? "/us/newsroom" : "/newsroom"}
              />
            )}
          </>
        ) : (
