// Generated from components/survey/ResultsTable.tsx. Run npm run localize:resources; do not edit directly.
"use client";
...
import AddHolidayForm from "@/components/survey/AddHolidayForm";
                    ...
                    <div className="flex">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-amber-800">
                          ...
                          <button
                            onClick={() => {
                              const staffUrl = `${window.location.origin}/us/tools/survey-preferences/s/${results.survey.id}`;
