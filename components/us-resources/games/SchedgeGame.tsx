// Generated from components/games/SchedgeGame.tsx. Run npm run localize:resources; do not edit directly.
"use client";

import styles from "@/components/games/SchedgeGame.module.css";
