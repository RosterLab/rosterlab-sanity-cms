      ...
      if (response.ok) {
        ...
        setTimeout(() => {
          ...
          if (!isContentGate && !testMode) {
            ...
            router.push("/us/case-studies/how-plastics-department-used-roster-simulation-to-cut-in-costs?utm_source=modal&utm_medium=popup&utm_campaign=site_offering&utm_content=var_b");
          } else if (testMode) {
              ...
              <article className="bg-white rounded-lg shadow-2xl overflow-hidden hover:shadow-3xl transition-shadow">
                ...
                <div className="p-3 sm:p-4 lg:p-5">
                  ...
                  <p className="text-neutral-600 mb-0 line-clamp-2 sm:line-clamp-3 text-[11px] sm:text-xs lg:text-sm">
                    Saved thousands per week from the first schedule: how a department of physicians in training with complex healthcare scheduling needs moved from spreadsheets to evidence-based planning.
                  </p>
                </div>
              </article>
