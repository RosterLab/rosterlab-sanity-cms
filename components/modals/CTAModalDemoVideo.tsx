    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 animate-fade-in">
      ...
      >
        ...
        <div className="grid md:grid-cols-5 gap-0">
          ...
          <div className="relative bg-gradient-to-br from-violet-600 via-purple-600 to-fuchsia-600 p-10 md:p-16 flex items-center justify-center min-h-[500px] md:min-h-[700px] md:col-span-2">
            {/* Decorative elements */}
            ...
            <div className="relative w-full max-w-md z-10">
              {/* FREE ACCESS badge */}
              <div className="absolute -top-5 left-0 z-10 animate-pulse">
                <span className="inline-flex items-center gap-2 bg-yellow-400 text-yellow-900 text-sm font-bold px-5 py-2.5 rounded-lg uppercase tracking-wide shadow-xl">
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
                    viewBox="0 0 20 20"
              ...
              {/* Video card */}
              <div className="bg-white/10 backdrop-blur-lg rounded-2xl overflow-hidden shadow-2xl border border-white/20 mt-8">
                ...
                <div className="relative w-full aspect-video flex items-center justify-center">
                  ...
                  {/* Play icon */}
                  <div className="relative z-10 w-20 h-20 bg-white rounded-full flex items-center justify-center group-hover:scale-110 transition-transform shadow-2xl">
                    <svg
                  ...
                  {/* Duration badge */}
                  <div className="absolute bottom-4 right-4 bg-black/60 backdrop-blur-sm text-white text-sm font-semibold px-3 py-1 rounded-lg">
                    5:00
                  </div>
                </div>
          ...
          <div className="p-10 md:p-16 flex flex-col justify-center md:col-span-3">
              ...
              <>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="relative" ref={industryDropdownRef}>
                        <button
                          ...
                          className="w-full px-3 py-2 pr-10 border border-neutral-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-white cursor-pointer hover:border-neutral-400 transition-colors text-left"
                        >
                          ...
                          <div className="absolute z-10 mt-1 w-full bg-white border border-neutral-300 rounded-lg shadow-lg max-h-60 overflow-auto">
                            {[
                              ...
                              <button
                                ...
                                className="w-full px-3 py-2 text-left hover:bg-purple-50 transition-colors text-neutral-900"
                              >
                                {option}
                              </button>
                            ))}
                  ...
                  <button
                    ...
                    className="w-full bg-purple-600 hover:bg-purple-700 disabled:bg-neutral-300 disabled:text-neutral-500 disabled:cursor-not-allowed text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-200 shadow-lg hover:shadow-xl disabled:shadow-none flex items-center justify-center gap-2"
                  >
                    {isSubmitting ? (
                      <>
                        <svg
            ...
            <div>
              <div className="relative overflow-hidden">
                <div className="flex gap-8 logo-scroll">
                  {/* First set of logos */}
                  <img
