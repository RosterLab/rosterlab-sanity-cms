...
const messagesByCategory = {
  "How do I setup a fair schedule?": [
    {
      question: "How do I set up a safe schedule?",
      answer:
  ...
  "Are there any risks for staff fatigue?": [
    {
      ...
      answer:
        "Fatigue is a critical safety concern. Based on your schedule data, I've identified some potential fatigue risks: Sarah is scheduled for 6 consecutive shifts, and Tom has only 9 hours between shifts.",
    },
    {
      question: "Are there any risks for staff fatigue?",
      answer:
  ...
  "How do I set up compliance rules for staff?": [
    {
      question: "How do I set up compliance rules for staff?",
      answer:
        "Labor compliance requires maximum 40 hours per week for standard employment, and minimum 2 consecutive days off per week.",
    },
    {
      question: "How do I set up compliance rules for staff?",
      answer:
        "Would you like me to tell you how to set up some compliant rules to get started?",
    },
  ],
...
export default function OttoStaticChatFeature1US() {
    ...
    <div className="w-full max-w-[550px] mx-auto bg-white rounded-lg shadow-xl p-6 flex flex-col">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-3 pb-4 border-b border-gray-200">
        ...
        >
          ...
          <option value="How do I setup a fair schedule?">
            How do I set up a safe schedule?
          </option>
          ...
          <option value="How do I set up compliance rules for staff?">
            How do I set up compliance rules for staff?
          </option>
