...
export type PageBuilderSection = Hero | Pricing | Testimonial | TextSection | CTASection
...
export interface PostsQueryResult {
  posts: Pick<Post, '_id' | 'title' | 'slug' | 'excerpt' | 'mainImage' | 'publishedAt'> & {
...
export interface PageQueryResult extends Page {}

export interface CategoriesQueryResult {
  categories: Category[]
}

export interface SettingsQueryResult extends SiteSettings {}