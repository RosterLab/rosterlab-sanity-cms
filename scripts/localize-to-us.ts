...
const US_COMPONENT_MAPPINGS: Record<string, string> = {
  ...
  "from '@/components/sections/TrustedBy'":
    "from '@/app/us/components/TrustedBy'",
  "from '@/components/sections/Benefits'":
    "from '@/app/us/components/Benefits'",
  "from '@/components/sections/Onboarding'":
    "from '@/app/us/components/Onboarding'",
  "from '@/components/sections/IndustrySolutions'":
    "from '@/app/us/components/IndustrySolutions'",
  "from '@/components/sections/Testimonials'":
    "from '@/app/us/components/Testimonials'",
  "from '@/components/sections/FinalCTA'":
    "from '@/app/us/components/FinalCTA'",

  // UI components with US versions
  "from '@/components/ui/RosterLoadingBar'":
    "from '@/components/ui/ScheduleLoadingBar'",
  "from '@/components/ui/RosterGenerator'":
    "from '@/app/us/components/SchedulingGenerator'",
...
function localizeContent(
  ...
  const sortedTerms = Object.entries(TERMINOLOGY_MAP).sort(
...
function localizeFile(
  ...
  const fileType = inputPath.endsWith(".tsx")
    ? "tsx"
    : inputPath.endsWith(".ts")
      ? "ts"
      : inputPath.endsWith(".mdx")
        ? "mdx"
        : "md";
...
async function main(
  config: LocalizationConfig = { overwriteExisting: false, createBackup: true },
) {
  ...
  if (config.createBackup && existsSync(targetDir)) {
    backupDir = join(
      ...
      "..",
      "app",
      `us-backup-${new Date().toISOString().replace(/:/g, "-")}`,
    );
  ...
  const pagesToLocalize = [
    ...
    // Tools pages
    {
      source: "draft/roi-calculator/page.tsx",
      target: "tools/roi-calculator/page.tsx",
    },
    {
      source: "draft/roi-calculator/client.tsx",
      target: "tools/roi-calculator/client.tsx",
    },
    {
      source: "staff-rostering-interactive-demo/page.tsx",
      target: "product-tour/page.tsx",
    },
    {
      source: "staff-rostering-interactive-demo/client.tsx",
      target: "product-tour/client.tsx",
    },
    {
      source: "staff-rostering-interactive-demo/PageWrapper.tsx",
      target: "product-tour/PageWrapper.tsx",
    },

    // Solutions pages
    {
      source: "solutions/staff-roster-mobile-app/page.tsx",
      target: "solutions/staff-roster-mobile-app/page.tsx",
    },
    {
      source: "solutions/ai-staff-rostering/page.tsx",
      target: "solutions/ai-staff-schedule-maker/page.tsx",
    },
    {
      source: "solutions/free-staff-rostering-software/page.tsx",
      target: "solutions/free-staff-scheduling-tool/page.tsx",
    },

    // Feature pages
    {
      source: "feature/automated-rostering/page.tsx",
      target: "feature/auto-scheduling/page.tsx",
    },
    {
      source: "feature/open-shifts/page.tsx",
      target: "feature/open-shifts/page.tsx",
    },
    {
      source: "feature/shift-swaps/page.tsx",
      target: "feature/shift-swaps-and-trades/page.tsx",
    },
    {
      source: "feature/shift-swaps/ShiftSwapsContent.tsx",
      target: "feature/shift-swaps-and-trades/ShiftSwapsContent.tsx",
    },
    {
      source: "feature/shift-swaps/AuditTrailModule.tsx",
      target: "feature/shift-swaps-and-trades/AuditTrailModule.tsx",
    },
    {
      source: "feature/shift-swaps/WeekendRotationModule.tsx",
      target: "feature/shift-swaps-and-trades/WeekendRotationModule.tsx",
    },
    {
      source: "feature/leave-requests/page.tsx",
      target: "feature/time-off-requests/page.tsx",
    },
    {
      source: "feature/leave-requests/LeaveRequestDemo.tsx",
      target: "feature/time-off-requests/LeaveRequestDemo.tsx",
    },
    {
      source: "feature/self-scheduling/page.tsx",
      target: "feature/self-scheduling/page.tsx",
    },
    {
      source: "feature/re-rostering/page.tsx",
      target: "feature/staff-rescheduling/page.tsx",
    },

    // Industries pages
    { source: "industries/page.tsx", target: "industries/page.tsx" },
    {
      source: "industries/healthcare/page.tsx",
      target: "industries/healthcare-scheduling/page.tsx",
    },
    {
      source: "industries/healthcare/aged-care/page.tsx",
      target: "industries/healthcare/senior-care-scheduling/page.tsx",
    },
    {
      source: "industries/healthcare/ed-icu/page.tsx",
      target: "industries/healthcare/ed-icu-scheduling/page.tsx",
    },
    {
      source: "industries/healthcare/radiology/page.tsx",
      target: "industries/healthcare/radiology-scheduling/page.tsx",
    },
  ];
