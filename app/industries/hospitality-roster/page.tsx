...
export const metadata = withHreflang(
  {
    title: "Hospitality Staff Rostering Software",
    description:
...
export default function HospitalityPage() {
  return (
    <SiteLayout>
      {/* Hero Section */}
      <IndustryHero
        title="Hospitality Rostering Software for Teams"
        description="Reduce hospitality staff rostering admin by 90% with optimised and flexible rosters that can handle last-minute changes."
        analyticsLocation="Industry Page Hospitality Rostering"
        primaryCta={{
          href: "/book-a-demo",
          label: "Book a Demo",
          analyticsProperties: {
            cta_type: "demo",
            page_name: "Hospitality Rostering",
            section: "hero",
          },
        }}
        secondaryCta={{
