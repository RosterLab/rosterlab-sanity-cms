  ...
  <Container>
    <div className="text-center mb-12">
      ...
      <p className="text-xl text-gray-600 max-w-3xl mx-auto">
        Purpose-built rostering for the unique needs of each hospitality sector.
      </p>
    </div>
    ...
    <div className="bg-white rounded-lg shadow-lg p-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
        ...
        <div className="text-center group cursor-pointer">
          ...
          <h4 className="font-semibold text-gray-900">Catering Services</h4>
        </div>
        <div className="text-center group cursor-pointer">
          <div className="w-16 h-16 bg-sky-50 rounded-full flex items-center justify-center mx-auto mb-3 transition-all duration-200 group-hover:scale-110 group-hover:shadow-lg">
            <svg
        ...
        <div className="text-center group cursor-pointer">
          ...
          <h4 className="font-semibold text-gray-900">Fast Food Chains</h4>
        </div>
        <div className="text-center group cursor-pointer">
        ...
        <div className="text-center group cursor-pointer">
          ...
          <h4 className="font-semibold text-gray-900">Function Centres</h4>
        </div>
        <div className="text-center group cursor-pointer">
  ...
  <Container>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      >
        ...
        <p className="text-gray-600 mb-3 flex-grow">
          Automatically enforce employment agreements, fairness, and rest break
          requirements.
        </p>
      ...
      >
        ...
        <p className="text-gray-600 mb-3 flex-grow">
          Optimise all the staffing intricacies for better coverage across your
          venues.
        </p>
        <div className="flex items-center text-blue-600 font-medium mt-auto">
          Learn more
      ...
      >
        ...
        <p className="text-gray-600 mb-3 flex-grow">
          Staff can view schedules, set preferences, request leave, accept open
          shifts and manage swaps from any device.
        </p>
      ...
      >
        ...
        <p className="text-gray-600 mb-3 flex-grow">
          Better-quality rosters, self rostering, reduced bias perception, and
