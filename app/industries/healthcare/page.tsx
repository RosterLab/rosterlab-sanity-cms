...
export const metadata = withHreflang(
  {
    title: "Rostering Software for Healthcare",
    description:
...
export default async function HealthcarePage() {
  ...
  return (
    <SiteLayout>
      {/* Hero Section */}
      <IndustryHero
        title="Healthcare Rostering Software for Teams"
        description="Less time rostering, more time caring for patients. We specialise in all types of healthcare rosters, no matter how complex."
        analyticsLocation="Industry Page Healthcare Rostering"
        primaryCta={{
          href: "/book-a-demo",
          label: "Book a Demo",
          analyticsProperties: {
            cta_type: "demo",
            page_name: "Healthcare Rostering",
            section: "hero",
          },
        }}
        secondaryCta={{
          ...
          <div className="mt-12 bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <Link
                ...
                className="text-center group cursor-pointer"
              >
                <div className="w-16 h-16 bg-teal-50 rounded-full flex items-center justify-center mx-auto mb-3 transition-all duration-200 group-hover:scale-110 group-hover:shadow-lg">
                  <svg
                    className="w-8 h-8 text-teal-500 transition-transform duration-200 group-hover:scale-110"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
