      ...
      <section className="py-20 bg-white">
        <Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              <div className="text-5xl font-bold text-sky-500 mb-2">0</div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Manual Errors</h3>
              <p className="text-gray-600">
                Eliminate scheduling mistakes with automated validation and compliance checks
              </p>
            </div>
            <div className="text-center">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-lg shadow-xl p-8 md:p-12">
              ...
              <div className="text-center mt-6">
                <Button href="/case-studies" className="inline-flex items-center bg-blue-600 text-white hover:bg-blue-700 px-6 py-2 rounded-full font-medium transition-all">
                  View case studies
