...
export const metadata = withHreflang(
  {
    title: "Nurse Rostering Software",
    description:
...
export default function NurseRosteringV2Page() {
  return (
    <SiteLayout>
      {/* Hero Section */}
      <IndustryHero
        title="Build Safe, Fair Nurse Rosters"
        description="Create compliant AI rosters that respect your nurse preferences, maintain safe ratios, and honour union agreements."
        analyticsLocation="Industry Page Nurse Rostering"
        primaryCta={{
          href: "/book-a-demo",
          label: "Book a Demo",
          analyticsProperties: {
            cta_type: "demo",
            page_name: "Nurse Rostering",
            section: "hero",
          },
        }}
        secondaryCta={{
        ...
        image={{
          src: "/images/industries/nurses.webp",
          alt: "Nurses on a hospital ward",
        }}
      />
