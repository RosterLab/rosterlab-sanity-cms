...
export const metadata = withHreflang(
  {
    title: "Construction Rostering Software",
    description:
      "Streamline construction workforce rostering with AI. Coordinate contractors, subcontractors, and trades across multiple project sites for on-time delivery.",
    alternates: {
      canonical: "https://rosterlab.com/industries/construction-rostering",
    },
    openGraph: {
      title: "Construction Rostering Software - RosterLab",
      description:
        "Streamline construction workforce rostering with AI. Coordinate contractors, subcontractors, and trades across multiple project sites for on-time delivery.",
      type: "website",
      url: "https://rosterlab.com/industries/construction-rostering",
      images: [
        {
          url: "/images/construction-scheduling.jpg",
          width: 1200,
          height: 630,
          alt: "Construction workforce rostering with RosterLab",
        },
      ],
    },
    twitter: {
...
export default function ConstructionPage() {
  return (
    <SiteLayout>
      {/* Hero Section */}
      <IndustryHero
        title="Construction Rostering Software for Teams"
        description="Coordinate contractors, subcontractors, and trades across multiple sites with intelligent AI rostering for on-time project delivery."
        analyticsLocation="Industry Page Construction Rostering"
        primaryCta={{
          href: "/book-a-demo",
          label: "Book a Demo",
          analyticsProperties: {
            cta_type: "demo",
            page_name: "Construction Rostering",
            section: "hero",
          },
        }}
        secondaryCta={{
        ...
        image={{
          src: "/images/industries/construction.webp",
          alt: "Construction crew on a build site",
        }}
      />

      {/* Trusted By */}
      <TrustedByDualRow heading="Trusted by global teams with complex rostering" />
        ...
        <Container>
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Transform Your Construction Workforce Management
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Handle the unique complexities of construction rostering with
              AI-driven coordination across contractors, trades, and project
              sites.
            </p>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative">
                <Image
                  ...
                  alt="RosterLab construction platform showing AI-powered workforce rostering"
                  width={600}
                  height={500}
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-600 mt-1">
                        Manage contractors across multiple project sites
                        simultaneously
                      </p>
                    </div>
                  </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 text-sm">
                      Bring together general contractors, subcontractors, and
                      specialist trades into one unified roster. Manage
                      dependencies between electrical, plumbing, HVAC, and
                      structural work to keep projects on track.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 text-sm">
                      Manage workforce allocation across multiple construction
                      sites simultaneously. Optimise resource utilisation by
                      moving crews between projects based on progress stages and
                      priorities.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-gray-900 mb-1">
                      Track Certifications & Licences
                    </h3>
                    <p className="text-gray-600 text-sm">
                      Ensure proper certification coverage for specialist work
                      including electrical licences, crane operations, confined
                      space entry, height work permits, and trade
                      qualifications. Maintain site safety and compliance.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-gray-900 mb-1">
                      Reduce Project Delays & Costs
                    </h3>
                    <p className="text-gray-600 text-sm">
                      Optimise labour costs by reducing idle time, minimising
                      crew conflicts, and ensuring right-sized teams for each
                      project phase. Better coordination means fewer delays and
                      penalty clauses.
                    </p>
                  </div>
                </div>
        ...
        <Container>
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Purpose-built scheduling for the unique needs of each construction
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div className="text-center group cursor-pointer">
                <div className="w-16 h-16 bg-orange-50 rounded-full flex items-center justify-center mx-auto mb-3 transition-all duration-200 group-hover:scale-110 group-hover:shadow-lg">
                  <svg
                    className="w-8 h-8 text-orange-500 transition-transform duration-200 group-hover:scale-110"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
              ...
              <div className="text-center group cursor-pointer">
                <div className="w-16 h-16 bg-yellow-50 rounded-full flex items-center justify-center mx-auto mb-3 transition-all duration-200 group-hover:scale-110 group-hover:shadow-lg">
                  <svg
                    className="w-8 h-8 text-yellow-600 transition-transform duration-200 group-hover:scale-110"
                    fill="none"
                    stroke="currentColor"
                    strokeWidth="2"
                    viewBox="0 0 24 24"
      ...
      >
        <Container>
          <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">
            On-Time Projects, Safer Sites.
          </h3>
          <p className="text-white/90 text-lg max-w-3xl mx-auto mb-8">
            When construction managers spend less time on administrative tasks,
            they can focus on what matters most - delivering projects on time,
            on budget, and maintaining safe worksites.
          </p>
