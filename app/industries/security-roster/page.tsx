...
export default function SecurityPage() {
  return (
    <SiteLayout>
      {/* Hero Section */}
      <IndustryHero
        title="Security Rostering Software for Teams"
        description="Less time rostering, more time ensuring site security. We specialise in all types of security rosters, no matter how complex."
        analyticsLocation="Industry Page Security Rostering"
        primaryCta={{
          href: "/book-a-demo",
          label: "Book a Demo",
          analyticsProperties: {
            cta_type: "demo",
            page_name: "Security Rostering",
            section: "hero",
          },
        }}
        secondaryCta={{
