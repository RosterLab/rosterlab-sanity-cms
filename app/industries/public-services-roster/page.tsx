...
export default function PublicServicesPage() {
  return (
    <SiteLayout>
      {/* Hero Section */}
      <IndustryHero
        title="Public Services Rostering Software"
        description="Roster faster and more efficiently whilst meeting more staff preferences and managing fatigue."
        analyticsLocation="Industry Page Public Services Rostering"
        primaryCta={{
          href: "/book-a-demo",
          label: "Book a Demo",
          analyticsProperties: {
            cta_type: "demo",
            page_name: "Public Services Rostering",
            section: "hero",
          },
        }}
        secondaryCta={{
        ...
        image={{
          ...
          alt: "Public services staff at work",
        }}
      />
            ...
            <div className="relative">
              ...
              <div className="relative">
                <Image
                  ...
                  alt="RosterLab public services platform showing AI-powered rostering"
                  width={600}
                  height={500}
      ...
      >
        <Container>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              Schedule a Public Services Demo
            </Button>
            <Button
              href="/solutions/ai-roster-generator"
