...
export default function GroundCrewRosteringPage() {
  return (
    <SiteLayout>
      {/* Hero Section */}
      <IndustryHero
        title="Optimised, Efficient Ground Crew Rosters"
        description="Create intelligent AI rosters that balance baggage handlers, ramp agents, and GSE operators across shifts."
        analyticsLocation="Industry Page Ground Crew Rostering"
        primaryCta={{
          href: "/book-a-demo",
          label: "Book a Demo",
          analyticsProperties: {
            cta_type: "demo",
            page_name: "Ground Crew Rostering",
            section: "hero",
          },
        }}
        secondaryCta={{
