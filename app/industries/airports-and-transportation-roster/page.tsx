...
export const metadata = withHreflang(
  {
    title: "Airport & Transport Crew Rostering Software",
    description:
...
export default function AviationPage() {
  return (
    <SiteLayout>
      {/* Hero Section */}
      <IndustryHero
        title="Airports & Transportation Rostering Software"
        description="Less time rostering, more time ensuring safe operations. We specialise in all types of transportation rosters, from cabin crew to ground staff, no matter how complex."
        analyticsLocation="Industry Page Airports & Transportation Rostering"
        primaryCta={{
          href: "/book-a-demo",
          label: "Book a Demo",
          analyticsProperties: {
            cta_type: "demo",
            page_name: "Airports & Transportation Rostering",
            section: "hero",
          },
        }}
        secondaryCta={{
        ...
        image={{
          ...
          alt: "Airport and transportation crew at work",
        }}
      />
        ...
        <Container>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <Link
                href="/industries/airports-and-transportation-roster/ground-crew"
