...
export const metadata = withHreflang(
  {
    title: "Manufacturing Staff Rostering Software",
    description:
...
export default function ManufacturingPage() {
  return (
    <SiteLayout>
      {/* Hero Section */}
      <IndustryHero
        title="Manufacturing Rostering Software for Teams"
        description="Optimise your manufacturing teams and operations with better staff rostering, no matter how complex."
        analyticsLocation="Industry Page Manufacturing Rostering"
        primaryCta={{
          href: "/book-a-demo",
          label: "Book a Demo",
          analyticsProperties: {
            cta_type: "demo",
            page_name: "Manufacturing Rostering",
            section: "hero",
          },
        }}
        secondaryCta={{
