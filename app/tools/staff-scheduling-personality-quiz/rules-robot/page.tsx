...
export const metadata: Metadata = {
  ...
  description:
    "You're the guardian of compliance, the protector of protocols. Discover your rostering personality and learn how to leverage your systematic approach to staff scheduling.",
  robots: {
    index: false,
    follow: true,
  },
