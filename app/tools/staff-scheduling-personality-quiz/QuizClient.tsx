...
const quizQuestions = [
  {
    ...
    answers: [
      {
        id: "a",
        text: "Love it! Give me Excel and a glass of wine, and I'm happy.",
        personality: "spreadsheet",
      },
      {
        id: "b",
        text: "Giving people what they want is what I want.",
        personality: "social",
      },
      {
        id: "c",
        text: "Oh, I forgot - was it due today?",
        personality: "lastminute",
      },
      {
        id: "d",
        text: "It's a serious responsibility. There are rules!",
        personality: "rules",
      },
      {
        id: "e",
        text: "As long as nobody is upset, I'm good.",
  ...
  },
  {
    ...
    answers: [
      ...
      {
        id: "c",
        text: "Reviewing my formulas one last time.",
        personality: "spreadsheet",
      },
      {
        id: "d",
        text: "Making sure that Sarah and Ben aren't rostered together... again.",
        personality: "peacekeeper",
      },
      {
        id: "e",
        text: "Just starting... I work best under pressure.",
        personality: "lastminute",
      },
      {
        id: "f",
        text: "Checking that everyone is happy with my latest draft roster.",
        personality: "social",
      },
    ],
  },
  {
    id: 3,
    question:
      "You notice a series of shifts that break your union rules. What's your reaction?",
    answers: [
      {
        id: "a",
        text: "Let me see who's affected and talk to them.",
        personality: "peacekeeper",
      },
      {
        id: "b",
        text: "Didn't see that. We'll survive.",
        personality: "lastminute",
      },
      {
        id: "c",
        text: "NOT ON MY WATCH. Must fix immediately.",
        personality: "rules",
      },
      {
        id: "d",
        text: "Looks the other way, clicks share",
        personality: "nohope",
      },
      {
        id: "e",
        text: "I already built formulas to catch that.",
        personality: "spreadsheet",
      },
      {
        id: "f",
        text: "Oh no - will that upset anyone?",
        personality: "social",
      },
    ],
  },
  {
    ...
    answers: [
      {
        id: "a",
        text: "Pretend I didn't see the message.",
        personality: "nohope",
      },
      {
        id: "b",
        text: "Tell them it's too late, they will have to organise their own swap.",
        personality: "rules",
      },
      {
        id: "c",
      ...
      {
        id: "d",
        text: "I'm on it and shuffling things around.",
        personality: "social",
      },
      {
        id: "e",
        text: "Sigh and deal with them in the morning.",
        personality: "lastminute",
      },
      {
        id: "f",
        text: "My integrated webform has already sent this to the appropriate approver.",
        personality: "spreadsheet",
      },
    ],
  },
  {
    ...
    answers: [
      {
        id: "a",
        text: "Making everyone feel considered.",
        personality: "social",
      },
      { id: "b", text: "Team harmony and morale.", personality: "peacekeeper" },
      {
        id: "c",
        text: "Just surviving without too many complaints",
        personality: "nohope",
      },
      {
        id: "d",
        text: "Efficiency and optimization.",
        personality: "spreadsheet",
      },
      {
        id: "e",
        text: "Legal compliance and structure.",
        personality: "rules",
      },
      {
        id: "f",
        text: "Getting it done without losing my mind.",
        personality: "lastminute",
      },
    ],
  },
  {
    ...
    answers: [
      {
        id: "a",
        text: "Something I whipped up in an hour that somehow works.",
        personality: "lastminute",
      },
      {
        id: "b",
        text: "A roster that would pass any audit with flying colors.",
        personality: "rules",
      },
      {
        id: "c",
        text: "Everyone has the shifts they wanted.",
        personality: "social",
      },
      {
        id: "d",
        text: "Someone else doing the rostering instead of me",
        personality: "nohope",
      },
      {
        id: "e",
        text: "A statistically fair masterpiece.",
        personality: "spreadsheet",
      },
      {
        id: "f",
        text: "No one's crying and the group chat is chill.",
        personality: "peacekeeper",
      },
    ],
  },
  {
    ...
    answers: [
      {
        id: "a",
        text: "Figure out what happened, come with receipts.",
        personality: "rules",
      },
      {
        id: "b",
        text: "Cry in a quiet corner for a while",
        personality: "nohope",
      },
      {
        id: "c",
        text: "Calm the waters and realign the team.",
        personality: "peacekeeper",
      },
      {
        id: "d",
        text: "Try to patch it on the fly.",
        personality: "lastminute",
      },
      {
        id: "e",
        text: "Ask the team how they're feeling.",
        personality: "social",
      },
      {
        id: "f",
        text: "Diagnose the spreadsheet, how did I not have a formula for this situation?",
        personality: "spreadsheet",
      },
    ],
  },
  {
    ...
    answers: [
      {
        id: "a",
        text: "Anything that lets me see everyone's preferences.",
        personality: "peacekeeper",
      },
      {
        id: "b",
        text: "Whatever's quickest right now. Back of a napkin if I have to.",
        personality: "lastminute",
      },
      {
        id: "c",
        text: "A good old fashion pen and paper",
        personality: "nohope",
      },
      {
        id: "d",
        text: "A group chat, calendar, and lots of emojis.",
        personality: "social",
      },
      {
        id: "e",
        text: "Rules checking rostering software.",
        personality: "rules",
      },
      {
        id: "f",
        text: "Excel or Google Sheets with lots of formulas and conditional formatting.",
        personality: "spreadsheet",
      },
    ],
  },
...
export default function QuizClient() {
  ...
  const handleAnswer = (answerId: string) => {
    ...
    const selectedAnswer = quizQuestions[currentQuestion].answers.find(
      (a) => a.id === answerId,
    );
    if (selectedAnswer) {
      // Update scores
  ...
  const handleCopyLink = () => {
    navigator.clipboard
      .writeText(
        window.location.origin + "/tools/staff-scheduling-personality-quiz",
      )
      .then(() => {
        setLinkCopied(true);
          ...
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Based on research and testing, our personality quiz aims to open
                up new perspectives for you – about yourself, your roster, and
                your redeeming hero-like qualities to get that roster done.
              </p>
              <button
                onClick={handleStartQuiz}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="rounded-lg bg-white p-8 shadow-sm border border-gray-200 hover:shadow-lg hover:border-primary-300 transition-all duration-300 cursor-pointer group">
              ...
              <p className="text-gray-600">
                Focuses on fairness, vibes, and keeping everyone happy (even if
                the maths suffers).
              </p>
            </div>
            ...
            <div className="rounded-lg bg-white p-8 shadow-sm border border-gray-200 hover:shadow-lg hover:border-primary-300 transition-all duration-300 cursor-pointer group">
              ...
              <p className="text-gray-600">
                Thrives under pressure, makes the schedule the night before -
            ...
            <div className="rounded-lg bg-white p-8 shadow-sm border border-gray-200 hover:shadow-lg hover:border-primary-300 transition-all duration-300 cursor-pointer group">
              ...
              <p className="text-gray-600">
                Obsessed with compliance, laws, break times, and documentation.
                Follows compliance like it's scripture.
              </p>
            </div>

            <div className="rounded-lg bg-white p-8 shadow-sm border border-gray-200 hover:shadow-lg hover:border-primary-300 transition-all duration-300 cursor-pointer group">
              <h3 className="text-xl font-semibold text-gray-900 mb-3 group-hover:text-primary-600 transition-colors">
                The Peacekeeper Panda
              </h3>
              <p className="text-gray-600">
                Mediator type. Tries to balance personalities, time-off
                requests, and drama with a zen-like calm.
              </p>
            </div>
            ...
            <div className="rounded-lg bg-white p-8 shadow-sm border border-gray-200 hover:shadow-lg hover:border-primary-300 transition-all duration-300 cursor-pointer group">
              ...
              <p className="text-gray-600">
                Hides under desk while duct-taping chaos. Saves the day
      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-[#0a1929] to-[#1e3a5f]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
            Whether you're a Spreadsheet Sorcerer or a Last-Minute Magician,
            RosterLab can help streamline your scheduling process and give you
            back your time.
          </p>
