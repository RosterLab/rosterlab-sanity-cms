...
export const metadata: Metadata = {
  ...
  description:
    'Navigate scheduling chaos while hiding under your desk. Master of duct-taping gaps and smoothing swaps while muttering "I knew this would happen" - but always saving the day.',
  robots: {
    index: false,
    follow: true,
  },
