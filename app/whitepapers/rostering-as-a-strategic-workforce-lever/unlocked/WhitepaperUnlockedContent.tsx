          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl p-5 sm:p-8 mb-8">
              ...
              <div className="grid grid-cols-3 gap-3 sm:gap-6">
                <div className="text-center">
                  ...
                  <div className="text-xs sm:text-sm md:text-base text-neutral-600 leading-tight">
                    {isUS ? (
              ...
              <div className="relative">
                <div className="w-full" style={{ height: "800px" }}>
                  <iframe
                    ...
                    title={
                      isUS
                        ? "Scheduling as a Strategic Workforce Lever - Full Whitepaper"
                        : "Rostering as a Strategic Workforce Lever - Full Whitepaper"
                    }
                  />
                </div>
                <p className="text-center text-sm text-neutral-500 mt-4">
                  Use the navigation controls in the PDF viewer to browse all 13
                  pages
                </p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl shadow-xl p-12 text-center text-white">
              ...
              <p className="text-xl mb-8 opacity-90">
                See how RosterLab can help your organization achieve similar
                results
              </p>
              <a
