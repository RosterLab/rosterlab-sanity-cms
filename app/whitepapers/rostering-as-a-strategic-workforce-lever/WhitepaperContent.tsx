...
export default function WhitepaperPage({ isUS = false }: { isUS?: boolean }) {
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="text-center mb-8 sm:mb-12">
                ...
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-neutral-900 mb-4 sm:mb-6 leading-tight px-4">
                  {isUS ? <>Scheduling as a</> : <>Rostering as a</>}{" "}
                ...
                <p className="text-base sm:text-lg lg:text-xl text-neutral-600 max-w-3xl mx-auto px-4">
                  How healthcare executives can use intelligent scheduling to
                  solve their most pressing workforce challenges
                </p>
              </div>
                      ...
                      <div className="absolute left-[5%] top-8 sm:top-10 lg:top-12 w-[42%] sm:w-[45%] z-10 transform -rotate-[12deg] sm:-rotate-[15deg] hover:scale-105 transition-transform duration-300">
                        <div className="rounded-lg overflow-hidden shadow-xl">
                          <img
                            ...
                            alt={
                              isUS
                                ? "Whitepaper Cover - Scheduling as a Strategic Workforce Lever"
                                : "Whitepaper Cover - Rostering as a Strategic Workforce Lever"
                            }
                    ...
                    <div className="space-y-3 sm:space-y-4">
                      <div className="flex items-start gap-2 sm:gap-3">
                        ...
                        <p className="text-sm sm:text-base text-neutral-700">
                          {isUS ? (
                            <>
                              Poor scheduling is silently costing your hospital
                              — in turnover, agency spend, compliance risk, and
                              burnout — and most executives never measure it
                            </>
                          ) : (
                            <>
                              Poor rostering is silently costing your hospital —
                              in turnover, agency spend, compliance risk, and
                              burnout — and most executives never measure it
                            </>
                          )}
                      ...
                      <div className="flex items-start gap-2 sm:gap-3">
                        ...
                        <p className="text-sm sm:text-base text-neutral-700">
                          Workforce shortages are real, but many are compounded
                          by scheduling systems that are unfair, opaque, and
                          administratively broken
                        </p>
                      </div>
                      ...
                      <div className="flex items-start gap-2 sm:gap-3">
                        ...
                        <p className="text-sm sm:text-base text-neutral-700">
                          A real Auckland radiology department went from 40%
                          understaffed to fully staffed for the first time in 28
                          years — by fixing how they scheduled
                        </p>
                      </div>
                      ...
                      <div className="flex items-start gap-2 sm:gap-3">
                        ...
                        <p className="text-sm sm:text-base text-neutral-700">
                          {isUS ? (
                            <>
                              The financial case is concrete: $80K+ in annual
                              savings, 93% less time on scheduling, zero
                              compliance breaches
                            </>
                          ) : (
                            <>
                              The financial case is concrete: $80K+ in annual
                              savings, 93% less time on rostering, zero
                              compliance breaches
                            </>
                          )}
                        </p>
                  ...
                  <div className="bg-white rounded-3xl shadow-2xl p-6 sm:p-8 lg:p-10">
                    <div className="text-center mb-6 sm:mb-8">
                      ...
                      <p className="text-sm sm:text-base text-neutral-600">
                        Instant access to the full case study and strategic
                        framework
                      </p>
                    </div>
