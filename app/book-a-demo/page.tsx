              ...
              <div className="bg-white rounded-lg shadow-lg p-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-1">Understand Your Challenges</h3>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-1">Live Platform Demonstration</h3>
                      <p className="text-gray-600 text-sm">
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-lg shadow-lg p-8 border border-gray-100">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-700 text-sm">AI-Powered Optimization</span>
                  </div>
                  <div className="flex items-center">
                    <HiShieldCheck className="w-5 h-5 text-green-500 mr-2" />
                    <span className="text-gray-700 text-sm">Compliance Automation</span>
                  </div>
                  <div className="flex items-center">
                    <HiUserGroup className="w-5 h-5 text-blue-500 mr-2" />
                    <span className="text-gray-700 text-sm">Staff Self-Service</span>
                  </div>
                  <div className="flex items-center">
                    <HiChartBar className="w-5 h-5 text-purple-500 mr-2" />
                    <span className="text-gray-700 text-sm">Analytics & Insights</span>
                  </div>
                </div>
              </div>
