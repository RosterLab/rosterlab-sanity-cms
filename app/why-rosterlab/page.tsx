              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Eliminate the need for manual rostering - giving you time
                      back to focus on patient care and team wellbeing.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Maintain legal and union compliance so junior doctors can
                      work safely while having more flexibility.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Maintain optimal on-call coverage with min and max
                      staffing rules that automatically alert you to
                      understaffed shifts.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Consider staff preferences while ensuring fairness,
                      reducing burnout and supporting safer night-to-day
                      transitions.
                    </p>
                  </div>
                </div>
