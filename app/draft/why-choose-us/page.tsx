...
const reasons = [
  {
    ...
    description:
      "Our award-winning optimisation algorithms create schedules 90% faster while ensuring fairness and compliance.",
  },
  {
    icon: HiUserGroup,
    title: "Industry Expertise",
    description:
      "Proven across healthcare, manufacturing, retail, and service industries with deep understanding of sector-specific scheduling challenges.",
  },
  {
    icon: HiShieldCheck,
    title: "Proven Track Record",
    description:
      "Trusted by leading organisations across Australia and New Zealand with exceptional customer satisfaction.",
  },
  {
    icon: HiClock,
    title: "Rapid Implementation",
    description:
      "Get up and running in weeks, not months, with our streamlined onboarding and dedicated support team.",
  },
  {
    icon: HiChartBar,
    title: "Measurable ROI",
    description:
      "Significant reduction in scheduling time and substantial decrease in overtime costs within the first year.",
  },
  {
    icon: HiSupport,
    title: "24/7 Support",
    description:
      "Round-the-clock support from scheduling experts who understand your challenges and goals.",
  },
];
        ...
        <Container>
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Join hundreds of teams that have transformed their workforce
              management with our proven scheduling solution.
            </p>
      ...
      <div className="bg-gray-50 py-20">
        <Container>
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We're not just another scheduling software – we're your partner in
      ...
      <div className="bg-white py-20">
        <Container>
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our customers consistently achieve measurable improvements in
        ...
        <Container>
          <div className="text-center text-white max-w-4xl mx-auto">
            ...
            <blockquote className="text-2xl font-medium mb-6">
              "If Rosterlab can help with our complicated rostering needs, we
              are confident it will work for anyone."
            </blockquote>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                When you choose RosterLab, you're not just getting software –
                you're gaining a dedicated partner committed to your success.
              </p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Your personal guide through implementation and beyond
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Regular reviews to ensure you're getting maximum value
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
        ...
        <Container>
          <div className="text-center text-white max-w-3xl mx-auto">
            ...
            <p className="text-xl mb-12 opacity-90">
              See why organisations trust RosterLab to transform their workforce
              management.
            </p>
