            ...
            <div className="bg-white rounded-lg shadow-xl p-8 md:p-12">
              ...
              <div className="mb-8">
                <p className="text-gray-700 mb-6">
                  Thanks for connecting your Microsoft Entra ID (Azure AD) with
                  RosterLab. Your organisation has now been successfully
                  registered.
                </p>
                ...
                <div className="space-y-3 mb-8">
                  <div className="flex items-start">
                    ...
                    <p className="text-gray-700">
                      Your staff can now sign in using "Sign in with Microsoft"
                    </p>
                  </div>
                  <div className="flex items-start">
                    <span className="text-green-500 mr-3 mt-0.5">✅</span>
                    <p className="text-gray-700">
                      Security group claims will be passed through to RosterLab
                    </p>
                  </div>
                  <div className="flex items-start">
                    <span className="text-green-500 mr-3 mt-0.5">✅</span>
                    <p className="text-gray-700">
                      Access will be validated based on your approved groups and
                      tenant ID
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6">
                  <p className="text-gray-700">
                    ...
                    Let your RosterLab contact know once this step is complete.
                    We'll activate access and guide you through any remaining
                    onboarding.
                  </p>
                </div>

                <p className="text-gray-600">
                  If you run into any issues or aren't sure what to do next,
                  just get in touch with your RosterLab implementation manager
                  or email us at{" "}
                  <a
