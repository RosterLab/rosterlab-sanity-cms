...
export const metadata: Metadata = {
  ...
  description: 'Book a live demo with RosterLab to see how AI-powered scheduling slashes admin time, balances shifts, and fixes your toughest scheduling challenges.',
  alternates: {
