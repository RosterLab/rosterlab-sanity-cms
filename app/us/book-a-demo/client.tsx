        ...
        <Container>
          ...
          <div className="hidden lg:grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-xs">
                        See RosterLab in action with scenarios relevant to your <Link href="/us/industries" className="text-blue-600 hover:text-blue-700 underline">industry</Link>
                      </p>
                    </div>
                  </div>
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-lg shadow-lg p-8 border border-gray-100">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">
                  Tailored to your schedule type and industry
                </h2>
          ...
          <div className="hidden lg:block bg-blue-50 rounded-lg p-6 border-l-4 border-blue-500 mb-12 text-center">
            ...
            <Link href="/us/case-studies" className="inline-block mt-3 text-blue-600 hover:text-blue-700 text-sm font-medium underline">
              Read case study
            </Link>
          </div>
