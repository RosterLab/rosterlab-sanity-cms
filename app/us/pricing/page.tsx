...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "We strongly recommend <a href='/us/contact' class='text-blue-600 hover:underline'>contacting us</a> if you're scheduling for healthcare or non-healthcare teams with a minimum size of 30.<br><br>If you're simply looking for a digital solution to move away from Excel, feel free to <a href='https://app.rosterlab.com/signup' class='text-blue-600 hover:underline'>sign up for free</a>. If you're interested in using AI to generate and optimize schedules, <a href='/us/book-a-demo' class='text-blue-600 hover:underline'>book a chat</a> or start a live conversation with us to learn more.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "We charge based on the number of staff on schedule being generated by our AI. If you are looking for large enterprise solution, please <a href='/us/contact' class='text-blue-600 hover:underline'>reach out</a> to one of our team members for further discussion.",
  },
