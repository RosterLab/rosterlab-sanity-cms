// Generated from app/tools/fte-calculator/client.tsx. Run npm run localize:resources; do not edit directly.
"use client";
      ...
      <Container className="max-w-[1400px]">
        <section className="mb-6 sm:mb-7">
          ...
          <p className="mt-2.5 text-sm sm:text-[15px] text-[#55606B] max-w-none">
            Enter each shift in your demand model with its times and how many staff you need on each day of the week. We&apos;ll total the weekly hours and convert them into the full-time equivalents (FTE) required to cover the schedule.
          </p>
          {printDate && (
            ...
            <div className="text-xs font-medium uppercase tracking-wider text-[#55606B] mb-2 flex items-center gap-1.5">
              ...
              <span className="group relative inline-flex">
                ...
                >
                  ...
                  demand exactly as entered. Since staff take vacation,
