// Generated from app/tools/survey-preferences/admin/[surveyId]/client.tsx. Run npm run localize:resources; do not edit directly.
"use client";
...
import ResultsTable from "@/components/us-resources/survey/ResultsTable";
import type {
        ...
        {results.survey && (
          <div className="mt-6 bg-white rounded-lg border border-neutral-200 p-6">
            ...
            <div className="flex gap-3">
              <input
                type="text"
                value={`${window.location.origin}/us/tools/survey-preferences/s/${surveyId}`}
                readOnly
              ...
              <button
                onClick={() => {
                  navigator.clipboard.writeText(
                    `${window.location.origin}/us/tools/survey-preferences/s/${surveyId}`,
                  );
                  setCopied(true);
        ...
        <div className="mt-6 bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 rounded-lg p-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex flex-col gap-3">
              <a
                href="https://www.rosterlab.com/us/book-a-demo"
              ...
              <a
                href="https://www.rosterlab.com/us/pricing"
          ...
          <div className="mt-6 pt-6 border-t border-white/20">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              ...
              <div className="flex gap-2 w-full sm:w-auto">
                <input
                  type="text"
                  value={`${window.location.origin}/us/tools/survey-preferences`}
                  readOnly
                ...
                <button
                  onClick={() => {
                    navigator.clipboard.writeText(
                      `${window.location.origin}/us/tools/survey-preferences`,
                    );
                    setCopied(true);
                    setTimeout(() => setCopied(false), 2000);
