// Generated from app/(main)/tools/staff-scheduling-personality-quiz/chaos-carla/ChaosCarlaClient.tsx. Run npm run localize:resources; do not edit directly.
"use client";
    ...
    try {
      ...
      const segments = [
        ...
        },
        {
          ...
          label: "Worst-Case Strategist",
        },
        {
          percent: 15,
          color: [7, 89, 133] as [number, number, number],
          label: "Crisis Preparer",
        },
        {
          percent: 10,
      ...
      doc.setTextColor(...(textColor as [number, number, number]));
      doc.text(
        ": Track who's actually showing up in real-time",
        28 + tool1Width,
        currentY,
      );
      currentY += 8;
      ...
      doc.setTextColor(...(textColor as [number, number, number]));
      doc.text(
        ": Quick coverage when the inevitable happens",
        28 + tool2Width,
        currentY,
      );
      currentY += 8;
      ...
      doc.setTextColor(...(textColor as [number, number, number]));
      doc.text(
        ": Create multiple backup scenarios instantly",
        28 + tool3Width,
        currentY,
      );
      currentY += 8;
      ...
      doc.text("• ", 25, currentY);
      doc.setTextColor(...(linkBlue as [number, number, number]));
      const blog1Text = "Manage Night Shift Planning & Well-being Effectively";
      ...
      doc.link(28, currentY - 3, blog2Width, 4, {
        url: "https://rosterlab.com/us/blog/how-to-reduce-absenteeism-for-shift-workers",
      });
      currentY += 8;
      ...
      doc.text("• ", 25, currentY);
      doc.setTextColor(...(linkBlue as [number, number, number]));
      const blog3Text = "Scheduling Basics: Foundation for Success";
      ...
      doc.setTextColor(...(textColor as [number, number, number]));
      const helpText =
        "Let RosterLab handle the chaos with automated backup plans and real-time adjustments when things inevitably go wrong.";
          ...
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-lg text-gray-600 mb-8">
                You navigate scheduling chaos like a pro - often found hiding
                under your desk. Master of duct-taping gaps and smoothing swaps
                while muttering "I knew this would happen" at least once a week.
                Known to vent, but only after saving the day.
              </p>
          ...
          <div className="grid gap-8 md:grid-cols-3 mt-16">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 max-w-xs mx-auto">
                Found hiding under desks when chaos strikes, but somehow always
                saves the day.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 max-w-xs mx-auto">
                My shifts will need duct-taping... it's all coming back to me
                now.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 max-w-xs mx-auto">
                Who runs the world? My staff schedule. And it's running me into
                the ground.
              </p>
            </div>
          </div>
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-gray-600 mb-12 text-center max-w-4xl mx-auto">
            You navigate scheduling chaos like a pro - often found hiding under
            your desk. Master of duct-taping gaps and smoothing swaps while
            muttering "I knew this would happen" at least once a week. Known to
            vent, but only after saving the day.
          </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    <span className="font-semibold">Chaos Navigator:</span>{" "}
                    Expert at duct-taping gaps when everything falls apart
                  </p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    <span className="font-semibold">Swap Smoother:</span>{" "}
                    Masters the art of last-minute shift changes
                  </p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    <span className="font-semibold">Under-Desk Hider:</span>{" "}
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    <span className="font-semibold">Day Saver:</span> Always
                    pulls through despite the chaos
                  </p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    <span className="font-semibold">Prophetic Mutterer:</span>{" "}
                    "I knew this would happen" is your catchphrase
                  </p>
                </div>
              </div>
                ...
                <div className="relative w-56 h-56 sm:w-64 sm:h-64 lg:w-80 lg:h-80 overflow-visible">
                  ...
                  >
                    ...
                    <circle
                      ...
                      style={{
                        opacity:
                          hoveredSection && hoveredSection !== "backup"
                            ? 0.5
                            : 1,
                      }}
                    ...
                    <circle
                      ...
                      style={{
                        opacity:
                          hoveredSection && hoveredSection !== "worst"
                            ? 0.5
                            : 1,
                      }}
                    ...
                    <circle
                      ...
                      style={{
                        opacity:
                          hoveredSection && hoveredSection !== "reality"
                            ? 0.5
                            : 1,
                      }}
          ...
          <div className="grid gap-8 md:grid-cols-3 mb-12">
            <Link href="/us/solutions/staff-scheduling-mobile-app" className="block">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-lg h-full">
                ...
                <p className="text-gray-600 mb-4">
                  Track who's actually showing up in real-time and prepare for
            ...
            <Link href="/us/feature/shift-swaps-and-trades" className="block">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-lg h-full">
                ...
                <p className="text-gray-600 mb-4">
                  Quick coverage when the inevitable happens and everything goes
                  wrong.
                </p>
                <span className="text-primary-600 font-medium inline-flex items-center">
                  Learn more
      ...
      <section className="bg-gradient-to-b from-[#0a1929] to-[#1e3a5f] relative overflow-hidden py-8 md:py-10 lg:py-12">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full text-center relative z-10">
          ...
          <p className="text-xl text-white/90 mb-12 max-w-3xl mx-auto">
            ...
            while hiding under your desk. Let RosterLab handle the duct-taping
            and swap-smoothing, so you can emerge victorious without the stress.
          </p>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg max-w-md w-full p-6">
            ...
            <LeadCaptureForm
              ...
              metadata={{ personality: "chaos-carla" }}
              onSuccess={async () => {
