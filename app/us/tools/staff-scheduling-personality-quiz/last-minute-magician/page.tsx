...
import LastMinuteMagicianClient from "@/app/(main)/tools/staff-scheduling-personality-quiz/last-minute-magician/LastMinuteMagicianClient"
...
export default async function LastMinuteMagicianPage() {
  ...
  return <LastMinuteMagicianClient isUS recommendedPosts={recommendedPosts} />
}
