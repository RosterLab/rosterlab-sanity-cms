// Generated from app/(main)/tools/staff-scheduling-personality-quiz/social-butterfly/SocialButterflyClient.tsx. Run npm run localize:resources; do not edit directly.
"use client";
...
export default function SocialButterflyClient({
  ...
  const generatePDF = useCallback(async () => {
    try {
      ...
      doc.setTextColor(...(primaryColor as [number, number, number]));
      doc.text(
        "It sounds like you best fit: The Social Butterfly",
        20,
        currentY,
      );
      ...
      const segments = [
        ...
        },
        {
          ...
          label: "Fairness Advocate",
        },
        {
          percent: 20,
          color: [190, 24, 93] as [number, number, number],
          label: "Communication Champion",
        },
        {
          percent: 15,
          color: [159, 18, 57] as [number, number, number],
          label: "Team Harmonizer",
        },
        {
          percent: 10,
          color: [136, 19, 55] as [number, number, number],
      ...
      doc.setTextColor(...(textColor as [number, number, number]));
      doc.text(
        ": Keep everyone connected and engaged on the go",
        28 + tool1Width,
        currentY,
      );
      currentY += 8;
      ...
      doc.setTextColor(...(textColor as [number, number, number]));
      doc.text(
        ": Let your team trade shifts easily while maintaining fairness",
        28 + tool2Width,
        currentY,
      );
      currentY += 8;
      ...
      doc.link(28, currentY - 3, blog2Width, 4, {
        url: "https://rosterlab.com/us/blog/comprehensive-guide-shift-swaps",
      });
      currentY += 8;
      ...
      doc.text("• ", 25, currentY);
      doc.setTextColor(...(linkBlue as [number, number, number]));
      const blog3Text = "Rotating Schedules: Best Practices";
      ...
      doc.setTextColor(...(textColor as [number, number, number]));
      const helpText =
        "Let RosterLab help you create schedules that keep your team happy and engaged while maintaining operational efficiency.";
      ...
      // Save the PDF
      doc.save("Your Results - Social Butterfly - RosterLab.pdf");
    } catch (error) {
  ...
  return (
    <div className="bg-white relative">
          ...
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-lg text-gray-600 mb-8">
                Focuses on fairness, vibes, and keeping everyone happy. Your
                scheduling approach prioritizes team morale and interpersonal
                dynamics.
              </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full">
          ...
          <div className="grid gap-8 md:grid-cols-3 mt-16">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 max-w-xs mx-auto">
                Makes scheduling fun and keeps everyone dancing through their
                shifts.
              </p>
            </div>
          </div>
      ...
      {/* As the Social Butterfly Section */}
      <section
        id="as-social-butterfly-section"
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-gray-600 mb-12 text-center max-w-4xl mx-auto">
            You create schedules that keep everyone happy, ensuring fairness while
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    ...
                    Masters the art of team dynamics and interpersonal
                    connections
                  </p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    <span className="font-semibold">Fairness Advocate:</span>{" "}
                    Ensures everyone gets equal opportunities and balanced
                    workloads
                  </p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    ...
                    Keeps everyone informed, engaged, and feeling heard
                  </p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    <span className="font-semibold">Team Harmonizer:</span>{" "}
                    Balances individual needs with team goals seamlessly
                  </p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    <span className="font-semibold">Morale Booster:</span>{" "}
                    Creates schedules that keep spirits high and teams motivated
                  </p>
                </div>
              </div>
                ...
                <div className="relative w-56 h-56 sm:w-64 sm:h-64 lg:w-80 lg:h-80 overflow-visible">
                  ...
                  >
                    ...
                    <circle
                      ...
                      stroke="#0ea5e9"
                      strokeWidth={
                        hoveredSection === "relationship" ? "24" : "20"
                      }
                      ...
                      style={{
                        opacity:
                          hoveredSection && hoveredSection !== "relationship"
                            ? 0.5
                            : 1,
                      }}
                    ...
                    <circle
                      ...
                      style={{
                        opacity:
                          hoveredSection && hoveredSection !== "fairness"
                            ? 0.5
                            : 1,
                      }}
                    ...
                    <circle
                      ...
                      stroke="#0369a1"
                      strokeWidth={
                        hoveredSection === "communication" ? "24" : "20"
                      }
                      ...
                      style={{
                        opacity:
                          hoveredSection && hoveredSection !== "communication"
                            ? 0.5
                            : 1,
                      }}
                    ...
                    <circle
                      ...
                      stroke="#075985"
                      strokeWidth={
                        hoveredSection === "harmonizer" ? "24" : "20"
                      }
                      ...
                      style={{
                        opacity:
                          hoveredSection && hoveredSection !== "harmonizer"
                            ? 0.5
                            : 1,
                      }}
                    ...
                    <circle
                      ...
                      style={{
                        opacity:
                          hoveredSection && hoveredSection !== "morale"
                            ? 0.5
                            : 1,
                      }}
                        ...
                        <div className="text-center animate-fade-in p-2">
                          ...
                          <div className="text-xs sm:text-sm text-gray-600 whitespace-pre-line">
                            {hoveredSection === "relationship" &&
                              "Relationship\nBuilder"}
                            {hoveredSection === "fairness" &&
                              "Fairness\nAdvocate"}
                            {hoveredSection === "communication" &&
                              "Communication\nChampion"}
                            {hoveredSection === "harmonizer" &&
                              "Team\nHarmonizer"}
            ...
            <Link href="/us/solutions/staff-scheduling-mobile-app" className="block">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-lg h-full">
                ...
                <p className="text-gray-600 mb-4">
                  ...
                  schedule updates and team communication.
                </p>
                <span className="text-primary-600 font-medium inline-flex items-center">
                  Learn more
                  <svg
      ...
      <section className="bg-gradient-to-b from-[#0a1929] to-[#1e3a5f] relative overflow-hidden py-8 md:py-10 lg:py-12">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full text-center relative z-10">
          ...
          <p className="text-xl text-white/90 mb-12 max-w-3xl mx-auto">
            ...
            happiness and fairness. Let RosterLab help you create schedules that
            keep your team engaged while maintaining operational efficiency.
          </p>
