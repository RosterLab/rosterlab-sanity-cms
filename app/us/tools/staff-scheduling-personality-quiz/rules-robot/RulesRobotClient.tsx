// Generated from app/(main)/tools/staff-scheduling-personality-quiz/rules-robot/RulesRobotClient.tsx. Run npm run localize:resources; do not edit directly.
"use client";
          ...
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-lg text-gray-600 mb-8">
                ...
                Your schedule isn't just a schedule—it's a legally sound document
          ...
          <div className="grid gap-8 md:grid-cols-3 mt-16">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 max-w-xs mx-auto">
                Serves up schedules with precision and zero tolerance for rule
                violations.
              </p>
            </div>
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-gray-600 mb-12 text-center max-w-4xl mx-auto">
            ...
            ensures every schedule is legally sound and audit-ready.
          </p>
          ...
          <div className="grid gap-8 md:grid-cols-3 mb-12">
            <Link href="/us/solutions/staff-scheduling-mobile-app" className="block">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-lg h-full">
                ...
                <p className="text-gray-600 mb-4">
                  Empower your team with mobile access to schedules, shift swaps,
            ...
            <Link href="/us/solutions/ai-staff-schedule-maker" className="block">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-lg h-full">
                ...
                <p className="text-gray-600 mb-4">
                  Generate compliant schedules in seconds with AI that understands
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg max-w-md w-full p-6">
            ...
            <LeadCaptureForm
              ...
              metadata={{ personality: "rules-robot" }}
              onSuccess={async () => {
