// Generated from app/(main)/tools/staff-scheduling-personality-quiz/spreadsheet-sorcerer/SpreadsheetSorcererClient.tsx. Run npm run localize:resources; do not edit directly.
"use client";
...
export default function SpreadsheetSorcererClient({
  ...
  const generatePDF = useCallback(async () => {
    try {
      ...
      doc.setTextColor(...(primaryColor as [number, number, number]));
      doc.text(
        "It sounds like you best fit: The Spreadsheet Sorcerer",
        20,
        currentY,
      );
      ...
      doc.setTextColor(...(textColor as [number, number, number]));
      const description =
        "Master of formulas and pivot tables, you transform raw data into perfectly optimized schedules. Your spreadsheets are works of art that others can only dream of creating.";
      ...
      doc.setFontSize(14);
      doc.setTextColor(...(primaryColor as [number, number, number]));
      doc.text("Your Spreadsheet Sorcerer DNA", 105, currentY, {
        align: "center",
      });
      ...
      const segments = [
        ...
        {
          percent: 20,
          color: [29, 78, 216] as [number, number, number],
      ...
      doc.text("• ", 25, currentY);
      doc.setTextColor(...(linkBlue as [number, number, number]));
      const tool2Text = "Automation schedule generation";
      ...
      doc.setTextColor(...(textColor as [number, number, number]));
      doc.text(
        ": Automated shift management system",
        28 + tool3Width,
        currentY,
      );
      currentY += 8;
      ...
      doc.link(28, currentY - 3, blog2Width, 4, {
        url: "https://rosterlab.com/us/blog/fairer-scheduling-at-work-reducing-shift-bias",
      });
      currentY += 8;
      ...
      doc.link(28, currentY - 3, blog3Width, 4, {
        url: "https://rosterlab.com/us/blog/how-to-implement-self-scheduling",
      });
      currentY += 17;
      ...
      doc.setTextColor(...(textColor as [number, number, number]));
      const helpText =
        "Let RosterLab transform your complex spreadsheets into automated scheduling magic.";
          ...
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-lg text-gray-600 mb-8">
                Master of formulas and pivot tables. Your spreadsheets are works
                of art that others can only dream of creating.
              </p>
          ...
          <div className="grid gap-8 md:grid-cols-3 mt-16">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 max-w-xs mx-auto">
                Covered in tattoos and conditional formatting. Prefers his
                tables locked and his nights free.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 max-w-xs mx-auto">
                Strong formulas. Stronger eyebrows. Can pivot table anything in
                under 60 seconds.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 max-w-xs mx-auto">
                Knows every keyboard shortcut. Once created a 12-tab workbook
                during a tea break.
              </p>
            </div>
          </div>
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-gray-600 mb-12 text-center max-w-4xl mx-auto">
            You wield formulas and functions like a wizard casts spells. Your
            ability to transform raw data into perfectly optimized schedules is
            legendary. Where others see chaos, you see patterns and
            possibilities.
          </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    <span className="font-semibold">Formula Master:</span>{" "}
                    Complex calculations are your playground - VLOOKUP,
                    INDEX-MATCH, and array formulas hold no secrets
                  </p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    <span className="font-semibold">Data Visualizer:</span> Your
                    charts and graphs tell compelling stories that make complex
                    schedules instantly understandable
                  </p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    <span className="font-semibold">Automation Expert:</span>{" "}
                    Macros and scripts save hours of work, turning repetitive
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    <span className="font-semibold">Pattern Recognizer:</span>{" "}
                    You spot staffing trends and scheduling patterns that others
                    miss completely
                  </p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    <span className="font-semibold">Efficiency Optimizer:</span>{" "}
                    Every cell has a purpose, every formula is optimized, and
                ...
                <div className="relative w-56 h-56 sm:w-64 sm:h-64 lg:w-80 lg:h-80 overflow-visible">
                  ...
                  >
                    ...
                    <circle
                      ...
                      style={{
                        opacity:
                          hoveredSection && hoveredSection !== "formula"
                            ? 0.5
                            : 1,
                      }}
                    ...
                    <circle
                      ...
                      stroke="#2563EB"
                      strokeWidth={
                        hoveredSection === "visualizer" ? "24" : "20"
                      }
                      ...
                      style={{
                        opacity:
                          hoveredSection && hoveredSection !== "visualizer"
                            ? 0.5
                            : 1,
                      }}
                    ...
                    <circle
                      ...
                      stroke="#1D4ED8"
                      strokeWidth={
                        hoveredSection === "automation" ? "24" : "20"
                      }
                      ...
                      style={{
                        opacity:
                          hoveredSection && hoveredSection !== "automation"
                            ? 0.5
                            : 1,
                      }}
                    ...
                    <circle
                      ...
                      style={{
                        opacity:
                          hoveredSection && hoveredSection !== "pattern"
                            ? 0.5
                            : 1,
                      }}
                    ...
                    <circle
                      ...
                      stroke="#1E3A8A"
                      strokeWidth={
                        hoveredSection === "efficiency" ? "24" : "20"
                      }
                      ...
                      style={{
                        opacity:
                          hoveredSection && hoveredSection !== "efficiency"
                            ? 0.5
                            : 1,
                      }}
                      ...
                      {hoveredSection && (
                        <div className="text-center animate-fade-in p-2">
                          ...
                          <div className="text-xs sm:text-sm text-gray-600 whitespace-pre-line">
                            ...
                            {hoveredSection === "visualizer" &&
                              "Data\nVisualizer"}
                            {hoveredSection === "automation" &&
                              "Automation\nExpert"}
                            {hoveredSection === "pattern" &&
                              "Pattern\nRecognizer"}
                            {hoveredSection === "efficiency" &&
                              "Efficiency\nOptimizer"}
                          </div>
                        </div>
                      )}
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <Link href="/us/solutions/staff-scheduling-mobile-app" className="block">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-lg h-full">
                ...
                <p className="text-gray-600 mb-4">
                  Take your perfectly crafted schedules mobile. Staff can view
            ...
            <Link href="/us/feature/shift-swaps-and-trades" className="block">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-lg h-full">
                ...
                <p className="text-gray-600 mb-4">
                  Automate shift swapping while maintaining your carefully
                  calculated balance. Every swap is tracked and optimized.
                </p>
                <span className="text-primary-600 font-medium inline-flex items-center">
                  Learn more
                  <svg
      ...
      <section className="bg-gradient-to-b from-[#0a1929] to-[#1e3a5f] relative overflow-hidden py-8 md:py-10 lg:py-12">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full text-center relative z-10">
          ...
          <p className="text-xl text-white/90 mb-12 max-w-3xl mx-auto">
            ...
            enhance your capabilities. Let RosterLab take your scheduling
            wizardry to the next level.
          </p>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg max-w-md w-full p-6">
            ...
            <LeadCaptureForm
              ...
              metadata={{ personality: "spreadsheet-sorcerer" }}
              onSuccess={async () => {
