// Generated from app/(main)/tools/staff-scheduling-personality-quiz/peacekeeper-panda/PeacekeeperPandaClient.tsx. Run npm run localize:resources; do not edit directly.
"use client";
...
export default function PeacekeeperPandaClient({
  ...
  const generatePDF = useCallback(async () => {
    try {
      ...
      doc.setTextColor(...(primaryColor as [number, number, number]));
      doc.text(
        "It sounds like you best fit: The Peacekeeper Panda",
        20,
        currentY,
      );
      ...
      doc.setFont("helvetica", "normal");
      doc.setFontSize(10);
      doc.text("  Finding inner peace in schedules", 25, currentY + 5);
      currentY += 12;

      // Celebrity 2 text
      doc.setFont("helvetica", "bold");
      doc.setFontSize(11);
      doc.text("• Sir Schedule Attenborough", 25, currentY);
      doc.setFont("helvetica", "normal");
      doc.setFontSize(10);
      ...
      doc.setFont("helvetica", "bold");
      doc.setFontSize(11);
      doc.text("• Zendaya Zen-schedule", 25, currentY);
      doc.setFont("helvetica", "normal");
      doc.setFontSize(10);
      ...
      doc.setTextColor(...(textColor as [number, number, number]));
      const pandaDesc =
        "You bring calm to chaos, resolving conflicts with wisdom and creating schedules that maintain workplace harmony and balance.";
      ...
      doc.setFontSize(14);
      doc.setTextColor(...(primaryColor as [number, number, number]));
      doc.text("Your Peacekeeper Panda DNA", 105, currentY, {
        align: "center",
      });
      ...
      const segments = [
        ...
        },
        {
          ...
          label: "Harmony Creator",
        },
        {
          percent: 10,
          color: [6, 78, 59] as [number, number, number],
      ...
      doc.setTextColor(...(textColor as [number, number, number]));
      doc.text(
        ": Foster communication and team connection",
        28 + tool1Width,
        currentY,
      );
      currentY += 8;
      ...
      doc.setTextColor(...(textColor as [number, number, number]));
      doc.text(
        ": Let teams collaborate on their ideal schedules",
        28 + tool2Width,
        currentY,
      );
      currentY += 8;
      ...
      doc.text("• ", 25, currentY);
      doc.setTextColor(...(linkBlue as [number, number, number]));
      const tool3Text = "Automation schedule generation";
      ...
      doc.link(28, currentY - 3, blog1Width, 4, {
        url: "https://rosterlab.com/us/blog/increase-staff-engagement-for-shift-workers",
      });
      currentY += 8;
      ...
      doc.link(28, currentY - 3, blog2Width, 4, {
        url: "https://rosterlab.com/us/blog/skeleton-staffing-guide-lean-operations-management",
      });
      currentY += 8;
      ...
      doc.setTextColor(...(textColor as [number, number, number]));
      const helpText =
        "Let RosterLab help you maintain workplace harmony with intelligent scheduling that balances everyone's needs.";
      ...
      // Save the PDF
      doc.save("Your Results - Peacekeeper Panda - RosterLab.pdf");
    } catch (error) {
  ...
  return (
    <div className="bg-white relative">
          ...
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-lg text-gray-600 mb-8">
                Mediator type who balances personalities and conflicts with
                zen-like calm. Your peaceful approach creates harmony in even
                the most chaotic scheduling situations.
              </p>
          ...
          <div className="grid gap-8 md:grid-cols-3 mt-16">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 max-w-xs mx-auto">
                Finding inner peace in schedule management, one shift at a time.
              </p>
            </div>
      ...
      {/* As the Peacekeeper Panda Section */}
      <section
        id="as-peacekeeper-panda-section"
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-gray-600 mb-12 text-center max-w-4xl mx-auto">
            You bring calm to chaos, resolving conflicts with wisdom and
            creating schedules that maintain workplace harmony and balance. Your
            diplomatic approach makes you the workplace zen master.
          </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    <span className="font-semibold">Conflict Resolver:</span>{" "}
                    Mediates disputes with diplomatic finesse and wisdom
                  </p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    <span className="font-semibold">Empathy Expert:</span>{" "}
                    Deeply understands every team member's unique needs
                  </p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    <span className="font-semibold">Balance Keeper:</span>{" "}
                    Maintains equilibrium in all scheduling situations
                  </p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    <span className="font-semibold">Harmony Creator:</span>{" "}
                    Builds peaceful and productive workplace environments
                  </p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    ...
                    Finds win-win solutions for everyone involved
                  </p>
                </div>
              </div>
                ...
                <div className="relative w-56 h-56 sm:w-64 sm:h-64 lg:w-80 lg:h-80 overflow-visible">
                  ...
                  >
                    ...
                    <circle
                      ...
                      style={{
                        opacity:
                          hoveredSection && hoveredSection !== "conflict"
                            ? 0.5
                            : 1,
                      }}
                    ...
                    <circle
                      ...
                      style={{
                        opacity:
                          hoveredSection && hoveredSection !== "empathy"
                            ? 0.5
                            : 1,
                      }}
                    ...
                    <circle
                      ...
                      style={{
                        opacity:
                          hoveredSection && hoveredSection !== "balance"
                            ? 0.5
                            : 1,
                      }}
                    ...
                    <circle
                      ...
                      style={{
                        opacity:
                          hoveredSection && hoveredSection !== "harmony"
                            ? 0.5
                            : 1,
                      }}
                    ...
                    <circle
                      ...
                      stroke="#164e63"
                      strokeWidth={
                        hoveredSection === "diplomatic" ? "24" : "20"
                      }
                      ...
                      style={{
                        opacity:
                          hoveredSection && hoveredSection !== "diplomatic"
                            ? 0.5
                            : 1,
                      }}
          ...
          <div className="grid gap-8 md:grid-cols-3 mb-12">
            <Link href="/us/solutions/staff-scheduling-mobile-app" className="block">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-lg h-full">
                ...
                <p className="text-gray-600 mb-4">
                  Foster communication and team connection with transparent
                  scheduling and easy collaboration.
                </p>
            ...
            <Link href="/us/feature/self-scheduling" className="block">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-lg h-full">
                ...
                <p className="text-gray-600 mb-4">
                  Let teams collaborate on their ideal schedules while
            ...
            <Link href="/us/solutions/ai-staff-schedule-maker" className="block">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-lg h-full">
                ...
                <p className="text-gray-600 mb-4">
                  Create balanced schedules automatically that consider everyone's
      ...
      <section className="bg-gradient-to-b from-[#0a1929] to-[#1e3a5f] relative overflow-hidden py-8 md:py-10 lg:py-12">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full text-center relative z-10">
          ...
          <p className="text-xl text-white/90 mb-12 max-w-3xl mx-auto">
            ...
            RosterLab help you maintain workplace harmony with intelligent
            scheduling that balances everyone's needs.
          </p>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg max-w-md w-full p-6">
            ...
            <LeadCaptureForm
              ...
              metadata={{ personality: "peacekeeper-panda" }}
              onSuccess={async () => {
