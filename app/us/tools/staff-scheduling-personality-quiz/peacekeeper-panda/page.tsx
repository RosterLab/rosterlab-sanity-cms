...
import PeacekeeperPandaClient from "@/app/(main)/tools/staff-scheduling-personality-quiz/peacekeeper-panda/PeacekeeperPandaClient"
...
export default async function PeacekeeperPandaPage() {
  ...
  return <PeacekeeperPandaClient isUS recommendedPosts={recommendedPosts} />
}
