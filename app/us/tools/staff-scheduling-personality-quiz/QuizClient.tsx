// Generated from app/(main)/tools/staff-scheduling-personality-quiz/QuizClient.tsx. Run npm run localize:resources; do not edit directly.
'use client'
...
const quizQuestions = [
  {
    id: 1,
    question: "How do you feel about scheduling?",
    answers: [
  ...
  {
    id: 2,
    question: "Your schedule is due tomorrow. What are you doing now?",
    answers: [
      { id: 'a', text: "Relaxing. The schedule is done.", personality: 'rules' },
      { id: 'b', text: "AHHHHGH!", personality: 'nohope' },
      { id: 'c', text: "Reviewing my formulas one last time.", personality: 'spreadsheet' },
      { id: 'd', text: "Making sure that Sarah and Ben aren't scheduled together... again.", personality: 'peacekeeper' },
      { id: 'e', text: "Just starting... I work best under pressure.", personality: 'lastminute' },
      { id: 'f', text: "Checking that everyone is happy with my latest draft schedule.", personality: 'social' }
    ]
  },
  {
    id: 3,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'b', text: "Tell them it's too late, they will have to organize their own swap.", personality: 'rules' },
  ...
  {
    id: 5,
    question: "What do you care about most in a schedule?",
    answers: [
  ...
  {
    id: 6,
    question: "Your ideal schedule looks like...",
    answers: [
      { id: 'a', text: "Something I whipped up in an hour that somehow works.", personality: 'lastminute' },
      { id: 'b', text: "A schedule that would pass any audit with flying colors.", personality: 'rules' },
      { id: 'c', text: "Everyone has the shifts they wanted.", personality: 'social' },
      { id: 'd', text: "Someone else doing the scheduling instead of me", personality: 'nohope' },
  ...
  {
    id: 8,
    question: "What tool do you prefer to use for scheduling?",
    answers: [
      ...
      { id: 'e', text: "Rules checking scheduling software.", personality: 'rules' },
...
const personalityUrls: Record<string, string> = {
  'spreadsheet': "/us/tools/staff-scheduling-personality-quiz/spreadsheet-sorcerer",
  'peacekeeper': "/us/tools/staff-scheduling-personality-quiz/peacekeeper-panda",
  'social': "/us/tools/staff-scheduling-personality-quiz/social-butterfly",
  'rules': "/us/tools/staff-scheduling-personality-quiz/rules-robot",
  'lastminute': "/us/tools/staff-scheduling-personality-quiz/last-minute-magician",
  'nohope': "/us/tools/staff-scheduling-personality-quiz/chaos-carla"
}
...
export default function QuizClient() {
  ...
  const handleCopyLink = () => {
    navigator.clipboard.writeText(window.location.origin + "/us/tools/staff-scheduling-personality-quiz")
      .then(() => {
        setLinkCopied(true)
          ...
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            ...
            <div className="relative h-96 rounded-lg overflow-hidden">
              <Image
                ...
                alt="Scheduling quiz characters"
                fill
