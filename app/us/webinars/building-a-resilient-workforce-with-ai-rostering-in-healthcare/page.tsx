...
export const metadata: Metadata = resourceMetadata({
  title:
    "Building a Resilient Healthcare Workforce with AI Staff Schedules - Webinar",
  description:
    "Watch our webinar with Mike Peterson and Sunny Feng as they explore how AI-powered scheduling can save hundreds of hours and build more resilient healthcare teams.",
  openGraph: {
    title:
