...
export const metadata = withHreflang(
  {
    ...
    alternates: {
      canonical:
        "https://rosterlab.com/us/industries/healthcare/dental-clinic-scheduling",
    },
    openGraph: {
      title: "Dental Clinic Scheduling Software - RosterLab",
      description:
...
export default function DentalClinicSchedulingPage() {
  return (
    <SiteLayout>
      {/* Hero Section */}
        ...
        <Container>
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Better Dental Staffing Starts with Smart Scheduling
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Build efficient and fair dental clinic schedules in minutes, not
              days. Discover how:
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                ...
                and surgical setups with skill-based scheduling rules.
              </p>
            </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      ...
                      dentists to treatment chairs, optimizing patient flow and
        ...
        <Container>
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Smile-Worthy Dental Scheduling Features
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
        ...
        <Container>
          <div className="text-center text-white">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Build Smarter, Fairer Dental Clinic Schedules
            </h2>
            <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
              Join dental clinics that have streamlined scheduling and improved
              staff satisfaction
            </p>
