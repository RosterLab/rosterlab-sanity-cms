...
export const metadata = withHreflang(
  {
    title: "Telehealth Staff Scheduling Software",
    description:
...
export default function TelehealthRosteringPage() {
  return (
    <SiteLayout>
      {/* Hero Section */}
      <IndustryHero
        title="Flexible, Optimized Telehealth Schedules"
        description="Create optimized AI schedules that balance consultation demands, fair shift distribution, and telehealth staff well-being."
        analyticsLocation="US Industry Page Telehealth Scheduling"
        primaryCta={{
          href: "/us/book-a-demo",
          label: "Book a Demo",
          analyticsProperties: {
            cta_type: "demo",
            page_name: "Telehealth Scheduling",
            section: "hero",
          },
        }}
        secondaryCta={{
        ...
        <Container>
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Essential Features for Telehealth Scheduling
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
