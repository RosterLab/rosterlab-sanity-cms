...
export const metadata = withHreflang(
  {
    title: "Radiography Staff Scheduling Software",
    description:
...
export default function RadiographyPage() {
  return (
    <SiteLayout>
      {/* Hero Section */}
      <IndustryHero
        title="Build Complex Radiography Schedules"
        ...
        analyticsLocation="US Industry Page Radiography Scheduling"
        primaryCta={{
          href: "/us/book-a-demo",
          label: "Book a Demo",
          analyticsProperties: {
            cta_type: "demo",
            page_name: "Radiography Scheduling",
            section: "hero",
          },
        }}
        secondaryCta={{
        ...
        image={{
          ...
          alt: "Radiologic technologist operating imaging equipment",
