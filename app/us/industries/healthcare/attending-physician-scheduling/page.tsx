...
export default function SeniorMedicalOfficerRosteringPage() {
  return (
    <SiteLayout>
      {/* Hero Section */}
      <IndustryHero
        title="Flexible, Personalized Attending Physician Schedules"
        description="Balance work commitments, personal preferences, and department coverage with ease."
        analyticsLocation="US Industry Page Attending Physician Scheduling"
        primaryCta={{
          href: "/us/book-a-demo",
          label: "Book a Demo",
          analyticsProperties: {
            cta_type: "demo",
            page_name: "Attending Physician Scheduling",
            section: "hero",
          },
        }}
        secondaryCta={{
        ...
        image={{
          src: "/images/industries/senior-doctor.webp",
          alt: "Attending physicians in consultation",
        }}
      />
