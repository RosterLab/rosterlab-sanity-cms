...
export const metadata = withHreflang(
  {
    title: "Hospitality Staff Scheduling Software",
    description:
      "Learn how our scheduling software simplifies hospitality staff scheduling. Improve service quality, ensure compliance & save time.",
    alternates: {
...
export default function HospitalityPage() {
  return (
    <SiteLayout>
      {/* Hero Section */}
      <IndustryHero
        title="Hospitality Scheduling Software for Teams"
        description="Reduce hospitality staff scheduling admin by 90% with optimized and flexible schedules that can handle last-minute changes."
        analyticsLocation="US Industry Page Hospitality Scheduling"
        primaryCta={{
          href: "/us/book-a-demo",
          label: "Book a Demo",
          analyticsProperties: {
            cta_type: "demo",
            page_name: "Hospitality Scheduling",
            section: "hero",
          },
        }}
        secondaryCta={{
        ...
        <Container>
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Handle the unique complexities of hospitality scheduling with
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 text-sm">
                      ...
                      work-life balance. Fair, transparent schedules that
                      consider individual needs lead to happier staff, better
                      retention, and improved guest experiences.
                    </p>
                  </div>
                </div>
        ...
        <Container>
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Purpose-built scheduling for the unique needs of each hospitality
              sector.
            </p>
          </div>
