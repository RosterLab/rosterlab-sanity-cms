...
export const metadata = withHreflang(
  {
    title: "Security Staff Scheduling Software",
    description:
  ...
  "/us/industries/security-scheduling",
);
...
export default function SecurityPage() {
  return (
    <SiteLayout>
      {/* Hero Section */}
      <IndustryHero
        title="Security Scheduling Software for Teams"
        description="Less time scheduling, more time ensuring site security. We specialize in all types of security schedules, no matter how complex."
        analyticsLocation="US Industry Page Security Scheduling"
        primaryCta={{
          href: "/us/book-a-demo",
          label: "Book a Demo",
          analyticsProperties: {
            cta_type: "demo",
            page_name: "Security Scheduling",
            section: "hero",
          },
        }}
        secondaryCta={{
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 via-white to-green-50">
        <Container>
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Everything You Need for Security Scheduling
            </h2>
          </div>
