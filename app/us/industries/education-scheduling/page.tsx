...
export const metadata = withHreflang(
  {
    title: "Education Staff Scheduling Software",
    description:
    ...
    alternates: {
      canonical: "https://rosterlab.com/us/industries/education-scheduling",
    },
    openGraph: {
...
export default function EducationPage() {
  return (
    <SiteLayout>
      {/* Hero Section */}
      <IndustryHero
        title="Education Scheduling Software for Teams"
        description="Spend 90% less time building and adjusting your teacher and student schedules, no matter how complex."
        analyticsLocation="US Industry Page Education Scheduling"
        primaryCta={{
          href: "/us/book-a-demo",
          label: "Book a Demo",
          analyticsProperties: {
            cta_type: "demo",
            page_name: "Education Scheduling",
            section: "hero",
          },
        }}
        secondaryCta={{
        ...
        <Container>
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Purpose-built scheduling for the unique needs of each education
              sector.
            </p>
          </div>
