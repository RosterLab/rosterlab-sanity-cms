...
export const metadata = withHreflang(
  {
    title: "Manufacturing Staff Scheduling Software",
    description:
      "Learn how our scheduling software simplifies manufacturing staff scheduling. Improve production output, ensure compliance & save time.",
    alternates: {
      canonical: "https://rosterlab.com/us/industries/manufacturing-scheduling",
    },
    openGraph: {
      title: "Manufacturing Staff Scheduling Software - RosterLab",
      description:
        "Learn how our scheduling software simplifies manufacturing staff scheduling. Improve production output, ensure compliance & save time.",
      type: "website",
      url: "https://rosterlab.com/us/industries/manufacturing-scheduling",
      images: [
        {
  ...
  "/us/industries/manufacturing-scheduling",
);
...
export default function ManufacturingPage() {
  return (
    <SiteLayout>
      {/* Hero Section */}
      <IndustryHero
        title="Manufacturing Scheduling Software for Teams"
        description="Optimize your manufacturing teams and operations with better staff scheduling, no matter how complex."
        analyticsLocation="US Industry Page Manufacturing Scheduling"
        primaryCta={{
          href: "/us/book-a-demo",
          label: "Book a Demo",
          analyticsProperties: {
            cta_type: "demo",
            page_name: "Manufacturing Scheduling",
            section: "hero",
          },
        }}
        secondaryCta={{
        ...
        image={{
          ...
          alt: "Manufacturing team on the production floor",
        }}
      />
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 via-white to-green-50">
        <Container>
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Everything You Need for Manufacturing Scheduling
            </h2>
          </div>
