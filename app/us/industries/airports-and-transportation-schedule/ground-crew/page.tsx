...
export const metadata = withHreflang(
  {
    title: "Ground Crew Scheduling Software",
    description:
    ...
    alternates: {
      canonical:
        "https://rosterlab.com/us/industries/airports-and-transportation-schedule/ground-crew",
    },
    openGraph: {
...
const faqItems = [
  {
    ...
    answer:
      "Yes. Baggage handlers, ramp agents, and other ground crew can submit shift preferences, time-off requests, and availability through our mobile app. RosterLab's <a href='https://rosterlab.com/us/feature/self-scheduling' class='text-blue-600 hover:text-blue-700 underline'>self-scheduling feature</a> lets staff bid for available shifts while maintaining coverage requirements and certification rules.",
  },
  {
...
export default function GroundCrewSchedulingPage() {
  return (
    <SiteLayout>
      {/* Hero Section */}
      <IndustryHero
        title="Optimized, Efficient Ground Crew Schedules"
        description="Create intelligent AI schedules that balance baggage handlers, ramp agents, and GSE operators across shifts."
        analyticsLocation="US Industry Page Ground Crew Scheduling"
        primaryCta={{
          href: "/us/book-a-demo",
          label: "Book a Demo",
          analyticsProperties: {
            cta_type: "demo",
            page_name: "Ground Crew Scheduling",
            section: "hero",
          },
        }}
        secondaryCta={{
        ...
        image={{
          src: "/images/industries/airports.webp",
          alt: "Airport ground crew on the apron",
        }}
      />
        ...
        <Container>
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Better Airport Operations Start with Smart Ground Crew Scheduling
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Build efficient and fair ground crew schedules in minutes, not
              days. Discover how:
            </p>
          </div>
        ...
        <Container>
          <div className="text-center text-white">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Build Smarter, Fairer Ground Crew Schedules
            </h2>
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: "Industries", url: "/us/industries" },
          {
            ...
            url: "/us/industries/airports-and-transportation-schedule",
          },
          { name: "Ground Crew Scheduling" },
        ]}
      />
    </SiteLayout>
  );
