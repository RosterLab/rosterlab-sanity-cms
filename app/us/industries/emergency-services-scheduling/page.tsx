...
export default function PublicServicesPage() {
  return (
    <SiteLayout>
        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 lg:gap-10 items-center">
            ...
            <div className="relative mt-6 lg:mt-0">
              <Image
                src="/images/illustration/public-services.svg"
                alt="Public services workforce scheduling dashboard"
                width={600}
                height={400}
        ...
        <Container>
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              ...
              welfare with AI-driven scheduling built for emergency services.
            </p>
          </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 text-sm">
                      Automatically enforce legal obligations, labor union
                      agreements, and contractual rules. Maintain audit trails
                      and ensure compliance with rest requirements, maximum
                      hours, and qualification mandates.
                    </p>
                  </div>
                </div>
              </div>
      ...
      {/* Emergency Services Verticals */}
      <section className="py-20 bg-white">
        <Container>
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Tailored Solutions for Every Public Service Sector
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Purpose-built scheduling for the unique needs of each public
              service sector.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="text-center group cursor-pointer">
                ...
                <h4 className="font-semibold text-gray-900">Local Councils</h4>
              </div>
              <div className="text-center group cursor-pointer">
      ...
      >
        <Container>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              Schedule a Emergency Services Demo
            </Button>
            <Button
              href="/us/solutions/ai-staff-schedule-maker"
