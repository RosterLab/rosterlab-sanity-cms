    ...
    <SiteLayout>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-left">
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Whether you're managing healthcare providers, physicians, teachers, warehouse workers or pilots - RosterLab's intelligent scheduling adapts to your industry's unique requirements.
              </p>
              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-gray-700">Adapts to any industry's unique scheduling needs</span>
                </div>
                <div className="flex items-center gap-2">
                  <svg className="w-5 h-5 text-green-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="text-sm text-gray-700">90% faster scheduling with full compliance</span>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                From ICU to nursing homes, optimise staffing while ensuring compliance, skill mix requirements, and staff wellbeing. Our AI understands the complexities of 24/7 healthcare operations.
              </p>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-blue-100 to-blue-200 rounded-lg p-8 shadow-xl">
                <div className="grid grid-cols-2 gap-4">
                  <Link href="/us/industries/healthcare/ed-icu-scheduling" className="bg-white rounded-lg p-4 hover:shadow-lg transition-shadow relative group">
                  ...
                  <Link href="/us/industries/healthcare/senior-care-scheduling" className="bg-white rounded-lg p-4 hover:shadow-lg transition-shadow relative group">
                    <div className="absolute top-2 right-2">
                    ...
                    <h3 className="font-semibold text-gray-900 mb-1">Senior Care</h3>
                    <p className="text-sm text-gray-600">Resident-focused care</p>
                  </Link>
                  <Link href="/us/industries/healthcare/radiology-scheduling" className="bg-white rounded-lg p-4 hover:shadow-lg transition-shadow relative group">
                    <div className="absolute top-2 right-2">
                  ...
                  <Link href="/us/industries/healthcare-scheduling" className="bg-white rounded-lg p-4 hover:shadow-lg transition-shadow block relative group">
                    <div className="absolute top-2 right-2">
                      <svg className="w-4 h-4 text-gray-400 group-hover:text-blue-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                      </svg>
      ...
      <section className="py-20 bg-gray-50">
        <Container>
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Your Path to Perfect Schedules
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our streamlined process takes you from complex scheduling challenges to optimised schedules in just a few simple steps.
            </p>
          </div>
            ...
            <div className="space-y-8">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Configure industry-specific rules, compliance requirements, skill mix, and coverage demands to ensure complete schedule compliance.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Automatically generate schedules</h3>
                  <p className="text-gray-600">
