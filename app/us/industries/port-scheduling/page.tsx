...
export const metadata = withHreflang(
  {
    title: "Port Scheduling Software - RosterLab",
    description:
      "Build your port schedule with RosterLab. Automatically generate fair, compliant and flexible port schedules that save time and money.",
    alternates: {
      canonical: "https://rosterlab.com/us/industries/port-scheduling",
    },
    openGraph: {
      title: "Port Scheduling Software - RosterLab",
      description:
        "Build your port schedule with RosterLab. Automatically generate fair, compliant and flexible port schedules that save time and money.",
      type: "website",
      url: "https://rosterlab.com/us/industries/port-scheduling",
      images: [
        {
  ...
  "/us/industries/port-scheduling",
);

const faqItems = [
  {
    question: "What is a port schedule?",
    answer:
      "Port schedules are specialized schedules designed for maritime and port operations where staffing must adapt to vessel arrivals, tide schedules, and 24/7 operational demands. They're used for managing shift workers across cargo handling, stevedoring, crane operations, and vessel services. These schedules must balance operational efficiency with worker safety, regulatory compliance, and fair distribution of premium shifts.",
  },
  {
    question: "How does AI make port scheduling more effective?",
    answer:
      "AI automates the complex task of balancing fairness over extended periods with operational flexibility. In port operations where fairness in distributing premium shifts, night work, and weekend duties is critical, AI ensures equitable distribution while accommodating last minute changes. When operational demands and vessel schedules change, AI-powered rescheduling adjusts specific periods while automatically maintaining overall fairness. This transforms a process that would take days of manual work into minutes, while ensuring transparency and team morale.",
  },
];

export default function PortSchedulingPage() {
  return (
    <SiteLayout>
      {/* Hero Section */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="mb-8 space-y-2">
                <p className="text-gray-600 flex items-center justify-start">
                  ...
                  Create compliant with labor laws schedules that protect your
                ...
                <p className="text-gray-600 flex items-center justify-start">
                  ...
                  Easily reschedule staff as a result of last minute changes
                </p>
                <p className="text-gray-600 flex items-center justify-start">
                  <svg
                    className="w-5 h-5 text-green-500 mr-2"
            ...
            <div className="relative">
              <Image
                ...
                alt="Port schedule scheduling dashboard"
                width={600}
                height={400}
        ...
        <Container>
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Safer Port Operations Start with Smart Scheduling
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Build compliant and safe port schedules in minutes, not days.
              Discover how:
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                ...
                regulations or labor law requirements.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Port schedule planning made simple
              </h2>
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      ...
                      specialized equipment handlers for safe and efficient
                      operations.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Reschedule when vessel arrivals change without starting
        ...
        <Container>
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-4">
              Your Port Schedule Planning Workflow
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-all">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      When vessel schedules shift, reschedule affected periods
              ...
              <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-all">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">
                      Publish schedule to mobile
                    </h3>
                    <p className="text-gray-600">
                      Distribute schedules digitally to workers and track
            ...
            <div className="text-center mt-12">
              <p className="text-gray-600 mb-6">
                Ready to streamline your port scheduling?
              </p>
              <Button
                href="/us/book-a-demo"
        ...
        <Container>
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Port Scheduling Software for Maritime Operations
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            <Link href="/us/feature/auto-scheduling" className="block">
              <div className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow cursor-pointer h-full flex flex-col">
                ...
                <p className="text-base text-gray-600 mb-3 flex-grow">
                  Generate port schedules in minutes instead of days. Save hours
        ...
        <Container>
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-center text-gray-600 mb-12 text-lg">
              Common questions about port scheduling
            </p>
        ...
        <Container>
          <div className="text-center text-white">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Transform Your Port Scheduling
            </h2>
      ...
      <BreadcrumbSchema
        items={[
          { name: "Home", url: "/us" },
          { name: "Transportation", url: "/us/industries/transportation" },
          {
            name: "Port Scheduling",
            url: "/us/industries/transportation/port-scheduling",
          },
        ]}
      />
    </SiteLayout>
