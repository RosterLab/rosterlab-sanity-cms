...
export const metadata = withHreflang(
  {
    ...
    alternates: {
      canonical: "https://rosterlab.com/us/industries/construction-scheduling",
    },
    openGraph: {
...
export default function ConstructionPage() {
  return (
    <SiteLayout>
      {/* Hero Section */}
      <IndustryHero
        title="Construction Scheduling Software for Teams"
        description="Coordinate contractors, subcontractors, and trades across multiple sites with intelligent AI scheduling for on-time project delivery."
        analyticsLocation="US Industry Page Construction Scheduling"
        primaryCta={{
          href: "/us/book-a-demo",
          label: "Book a Demo",
          analyticsProperties: {
            cta_type: "demo",
            page_name: "Construction Scheduling",
            section: "hero",
          },
        }}
        secondaryCta={{
        ...
        <Container>
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Handle the unique complexities of construction scheduling with
            ...
            <div className="relative">
              ...
              <div className="relative">
                <Image
                  ...
                  alt="RosterLab construction platform showing AI-powered workforce scheduling"
                  width={600}
                  height={500}
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 text-sm">
                      ...
                      specialist trades into one unified schedule. Manage
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 text-sm">
                      ...
                      sites simultaneously. Optimize resource utilization by
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 text-sm">
                      ...
                      including electrical licenses, crane operations, confined
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 text-sm">
                      Optimize labor costs by reducing idle time, minimizing
