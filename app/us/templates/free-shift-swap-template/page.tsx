// Generated from app/templates/free-shift-swap-template/page.tsx. Run npm run localize:resources; do not edit directly.
          ...
          <Container>
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-3xl p-12 text-center text-white">
              ...
              <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
                While our template helps organize requests, RosterLab automates
