// Generated from app/templates/free-employee-of-the-month-certificate/page.tsx. Run npm run localize:resources; do not edit directly.
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              <div>
                ...
                <p className="text-xl text-gray-600 mb-8">
                  Recognize outstanding team members with our professionally
          ...
          <Container>
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-3xl p-12 text-center text-white">
              ...
              <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
                While certificates recognize great work, RosterLab helps create
