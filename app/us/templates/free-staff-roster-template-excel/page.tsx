// Generated from app/templates/free-staff-roster-template-excel/page.tsx. Run npm run localize:resources; do not edit directly.
...
import ExcelFormClient from "@/app/us/templates/free-staff-roster-template-excel/ExcelFormClient";
...
export const metadata: Metadata = resourceMetadata({
  ...
  alternates: {
    canonical:
      "https://rosterlab.com/us/templates/free-staff-roster-template-excel",
  },
  openGraph: {
    title: "Free Staff Schedule Template Excel - RosterLab",
    description:
    ...
    type: "website",
    url: "/us/templates/free-staff-roster-template-excel",
  },
  twitter: {
...
}, "/us/templates/free-staff-roster-template-excel");
...
const features = [
  {
    icon: HiTable,
    title: "Pre-formatted 6-week schedule",
    description:
...
const faqItems = [
  ...
  {
    question: "Should I use an Excel spreadsheet to schedule my staff?",
    answer:
          ...
          <Container>
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Everything you need to create professional staff schedules in
                Excel
              </p>
            </div>
              ...
              <div className="bg-white rounded-lg shadow-lg p-8 overflow-hidden">
                <div className="relative overflow-hidden rounded">
                  <Image
                    ...
                    alt="Excel schedule template preview showing a 6-week calendar with staff names, shift allocations, and automatic totals"
                    width={1200}
                    height={600}
          ...
          <Container>
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-center text-gray-600 mb-12 text-lg">
                Everything you need to know about our Excel schedule template
              </p>
          ...
          <Container>
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-3xl p-12 text-center text-white">
              ...
              <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
                ...
                optimized schedules in minutes, not hours. See how much time you
                could save.
              </p>
