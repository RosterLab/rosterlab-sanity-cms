// Generated from app/templates/free-staff-timesheet-template/TimesheetFormClient.tsx. Run npm run localize:resources; do not edit directly.
"use client";
...
// Download function
const downloadTimesheetFile = () => {
  // Track download
  trackButtonClick("Download Timesheet Template", "Timesheet Template Page", {
    form_type: "timesheet_download",
    download_type: "automatic",
  });

  // Create a temporary link to download the file
  const link = document.createElement("a");
  link.href = "/images/timesheet/Free-Timesheet-Template-RosterLab.docx";
  link.download = "Free-Timesheet-Template-RosterLab.docx";
    ...
    try {
      if (window.hbspt && window.hbspt.forms) {
        window.hbspt.forms.create({
          portalId: "20646833",
          formId: "b49cff03-442a-490a-8357-aa1672058a31",
          region: "na1",
          target: "#hubspot-form-container",
          ...usHubSpotFormOptions(),
          onFormSubmitted: () => {
            // Download the timesheet file
      ...
      {!isSubmitted ? (
        <>
          ...
          <p className="text-gray-600 mb-6">
            Fill out the form below to download your timesheet template
          </p>
        ...
        <div className="text-center py-8">
          ...
          <button
            ...
            onClick={() => {
              downloadTimesheetFile();
              trackButtonClick("Manual Download", "Timesheet Template Page", {
