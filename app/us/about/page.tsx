  ...
  return (
    <SiteLayout>
      ...
      <IndustryHero
        ...
        description="We transform the way scheduling works, making it faster, safer, and more efficient."
          ...
          <div className="mt-6 grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
            <div className="max-w-3xl">
              ...
              <p className="mt-6 text-lg leading-relaxed text-gray-700">
                That&apos;s why we are here. We automate the scheduling process
                using world-leading technology that no one else can match,
                allowing your team to spend less time scheduling and more time
