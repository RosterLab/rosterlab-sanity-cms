          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                We transform the way scheduling works, making it faster, safer,
                and more efficient.
              </p>
            ...
            {/* Desktop only: Timeline Illustration */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                ...
                away from critical clinical work to manage schedules.
              </p>
              <p className="text-lg text-gray-600 mb-8">
                That's why we are here. We automate the scheduling process using
                world-leading technology that no one else can match, allowing
                your team to spend less time scheduling and more time on what
                truly matters.
              </p>
              <Button
                href="/us/book-a-demo"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              ...
              <div className="bg-white rounded-lg shadow-lg p-6 text-center">
                ...
                <p className="text-sm text-gray-600 text-left">
                  ...
                  stage to global leader in AI scheduling.
                </p>
              </div>
          ...
          <div className="mx-auto" style={{ maxWidth: "1200px" }}>
            <div className="relative">
              ...
              <div className="relative flex items-center justify-between mb-16">
                ...
                <div className="w-5/12 pl-8">
                  <h3 className="text-xl font-bold text-gray-900">
                    World Champions In Automatic Scheduling
                  </h3>
                  <p className="text-gray-600 mt-2">
                    Our underlying technology has found the most optimal
                    solution to the International Nurse Scheduling Competition.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center justify-between mb-16">
                ...
                <div className="w-5/12 pl-8">
                  ...
                  <p className="text-gray-600 mt-2">
                    ...
                    united by a shared mission to fix broken scheduling systems
              ...
              <div className="relative flex items-center justify-between">
                ...
                <div className="w-5/12 pl-8">
                  ...
                  <p className="text-gray-600 mt-2">
                    Today, our staff scheduling software is used by hundreds of
          ...
          <div className="max-w-4xl mx-auto">
            <div className="p-8 bg-gray-50 rounded-lg shadow-lg border-l-4 border-blue-500 text-center">
              <p className="text-xl text-gray-800 italic mb-4">
                ...
                can't imagine reverting to manual scheduling."
              </p>
