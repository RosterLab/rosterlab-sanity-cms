// Generated from app/whitepapers/rostering-as-a-strategic-workforce-lever/page.tsx. Run npm run localize:resources; do not edit directly.
"use client";
  ...
  const onSubmit = async (data: WhitepaperFormData) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        link.href = "/whitepapers/rostering-as-a-strategic-workforce-lever-us.pdf";
        link.download = "RosterLab-Whitepaper-Scheduling-as-a-Strategic-Workforce-Lever-US.pdf";
                          ...
                          <div className="absolute left-[5%] top-8 sm:top-10 lg:top-12 w-[42%] sm:w-[45%] z-10 transform -rotate-[12deg] sm:-rotate-[15deg] hover:scale-105 transition-transform duration-300">
                            <div className="rounded-lg overflow-hidden shadow-xl">
                              <img
                                ...
                                alt="Whitepaper Cover - Scheduling as a Strategic Workforce Lever"
                        ...
                        <div className="space-y-3 sm:space-y-4">
                          <div className="flex items-start gap-2 sm:gap-3">
                            ...
                            <p className="text-sm sm:text-base text-neutral-700">
                              Poor scheduling is silently costing your hospital — in turnover, agency spend, compliance risk, and burnout — and most executives never measure it
                            </p>
                          </div>
