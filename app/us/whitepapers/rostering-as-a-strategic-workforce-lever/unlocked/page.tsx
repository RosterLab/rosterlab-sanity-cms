// Generated from app/whitepapers/rostering-as-a-strategic-workforce-lever/unlocked/page.tsx. Run npm run localize:resources; do not edit directly.
"use client";
            ...
            <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl p-5 sm:p-8 mb-8">
              ...
              <div className="grid grid-cols-3 gap-3 sm:gap-6">
                <div className="text-center">
                  ...
                  <div className="text-xs sm:text-sm md:text-base text-neutral-600 leading-tight">Reduction in scheduling time</div>
