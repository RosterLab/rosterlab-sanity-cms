    ...
    <div className="w-full max-w-4xl mx-auto p-8">
      <div className="relative" style={{ minHeight: "500px" }}>
        ...
        <div className="flex justify-between mb-32">
          {/* Daniel's Box */}
          <div
            className={`bg-white rounded-xl shadow-lg p-6 w-64 relative z-10 transition-all duration-500 ${
              step === 0
        ...
        >
          ...
          <p className="text-sm text-gray-600 text-center -mt-1">
            Swap sent on 10th May
          </p>
        </div>

        {/* Other text labels */}
        <div
          className={`absolute right-8 top-1/2 transform -translate-y-1/2 text-center transition-all duration-500 ${
            step >= 1 ? "opacity-100" : "opacity-0"
          }`}
          style={{ zIndex: 2 }}
        >
        ...
        <div
          className={`absolute left-8 top-1/2 transform -translate-y-1/2 text-center transition-all duration-500 ${
        ...
        {step === 2 && (
          <div
            className={`absolute bottom-0 left-0 right-0 bg-gray-50 rounded-xl p-4 transition-all duration-500 ${
              step === 2
                ? "opacity-100 transform translate-y-0"
                : "opacity-0 transform translate-y-10"
            }`}
            ...
            <div className="space-y-1 text-sm">
              <div className="flex justify-between">
                ...
                <span className="text-gray-800">
                  Daniel requested swap with Sunny
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">10 May 2024, 3:15 PM</span>
                <span className="text-gray-800">
                  Sunny accepted swap request
                </span>
              </div>
              <div className="flex justify-between">
