        ...
        <div className="bg-gradient-to-r from-[#4a9288] to-[#3d7970] px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-[#d1e7e4] mt-1">
                Manage and approve shift changes
              </p>
            </div>
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-amber-700 mt-0.5">
                          This swap would result in 48 hours worked this week,
                          exceeding the 40-hour limit
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-green-700 mt-0.5">
                        Weekly hours limit exception granted by manager
                      </p>
                    </div>
                  </div>
                </div>
