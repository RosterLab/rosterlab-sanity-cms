...
const faqItems = [
  {
    question: "What can the AI Schedule Assistant help me with?",
    answer:
      "Our AI Schedule Assistant can help you understand your schedule, answering questions about your schedule instantly. The AI understands your team's context, constraints, and preferences to provide relevant information.",
  },
  {
    question: "Can the AI Schedule Assistant make changes to my schedule?",
    answer:
      "The AI Schedule Assistant provides you with instant insights, tips and knowledge, but you maintain full control.",
  },
  {
    question: "What is Agentic AI for scheduling?",
    answer:
      "Agentic AI will revolutionize how we approach workforce scheduling. The ability to have AI autonomously handle complex scheduling tasks means more time for strategic planning and less time on administrative work.",
  },
  {
    question:
      "Is it possible to control Otto's access to information by user role?",
    answer:
      "Yes. Otto's access to information is restricted by existing user permissions, ensuring that each individual can only retrieve data they are authorized to view. Sensitive or administrative information remains fully protected and accessible solely to those with the appropriate access. Staff cannot use Otto to query content restricted to administrators.",
  },
];

export default function AIScheduleAssistantPage() {
  return (
    <SiteLayout>
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-xl text-gray-600 mb-8">
                  Otto is your virtual scheduling assistant here to help make
                  tasks and decisions easier. Ask Otto for insights and support
                  to build better schedules, for you and your team to succeed.
                </p>
        ...
        {/* Feature 1: Instant Scheduling Guidance */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-6">
                  Scheduling shouldn't feel like guesswork. Ask Otto anything
                  you need such as{" "}
                  <em>"Do I have enough people for next week?"</em> Or
                  <em>"Who's working too many nights?".</em> The AI knows your
                  schedule and people giving you personalized tips & insights.
                </p>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <HiCheck className="w-6 h-6 text-[#4a9288] mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">
                      Get instant answers to your scheduling questions without
                      manual searches
                    </span>
                  </li>
                  <li className="flex items-start">
                    <HiCheck className="w-6 h-6 text-[#4a9288] mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">
                      Save time by learning from real schedule data, not
                  ...
                  <li className="flex items-start">
                    <HiCheck className="w-6 h-6 text-[#4a9288] mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">
                      Build safer, fairer, more balanced schedules that work for
                      everyone
                    </span>
                  </li>
                </ul>
              ...
              <div>
                <OttoStaticChatFeature1US />
              </div>
            </div>
          </Container>
        </div>

        {/* Feature 2: Better Insights, Better Schedules */}
          ...
          <Container>
            <div className="max-w-4xl mx-auto text-center mb-12">
              ...
              <p className="text-lg text-gray-600 mb-12">
                Otto analyzes your scheduling data and provides the insights you
              ...
              <div>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <HiCheck className="w-6 h-6 text-[#4a9288] mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">
                      Deal with schedule changes in one place with AI assistance
                    </span>
                  </li>
                  <li className="flex items-start">
                    <HiCheck className="w-6 h-6 text-[#4a9288] mr-3 mt-0.5 flex-shrink-0" />
                  ...
                  <li className="flex items-start">
                    <HiCheck className="w-6 h-6 text-[#4a9288] mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">
                      Customized specifically to your schedule data
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="mt-16 max-w-xl mx-auto">
                <div className="bg-white rounded-xl shadow-lg p-8 md:p-10">
                  ...
                  <p className="text-gray-600 mb-6">
                    Be among the first to experience the future of scheduling
                  </p>
                  <WaitlistForm />
          ...
          <Container>
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-center text-gray-600 mb-12 text-lg">
                Common questions about the AI Scheduling Assistant
              </p>
          ...
          <Container>
            <div className="text-center text-white max-w-3xl mx-auto">
              <h2 className="text-4xl font-bold mb-6">
                Ready to experience the future of scheduling?
              </h2>
