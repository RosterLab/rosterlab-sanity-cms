...
export default function RoleTabsModuleUS() {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="flex flex-wrap gap-3 mb-8 justify-center">
        ...
        >
          For Team Leads / Schedule Coordinators
        </button>
        <button
          ...
          <div className="flex flex-col md:flex-row items-start gap-6">
            ...
            <div className="flex-1">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                Make Smarter Decisions, Informed By Scheduling Data
              </h3>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700">
                    Look up stats, coverage gaps, shift allocations and time off
                ...
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700">
                    Review workload distribution and ask about staff utilization
                ...
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700">
                    Get clear explanations about schedule changes, fairness and
          ...
          <div className="flex flex-col md:flex-row items-start gap-6">
            <div className="flex-shrink-0 w-full md:w-[280px]">
              <Image
                ...
                alt="For Team Leads / Schedule Admins"
                width={280}
                height={350}
                className="rounded-lg object-cover w-full h-auto"
              />
            ...
            <div className="flex-1">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                Build Better Schedules With AI Guidance
              </h3>
              <p className="text-gray-600 mb-6">
                Otto helps schedule coordinators build safe and fair schedules
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700">
                    Automatically add fairness, fatigue and compliance rules as
                    you build
                  </span>
                </li>
                <li className="flex items-start">
