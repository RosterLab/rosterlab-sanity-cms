...
const faqItems = [
  {
    ...
    answer:
      "An open shift is an unfilled work slot in your schedule that needs coverage. These can arise from last-minute call-outs, unexpected demand, or gaps in your original schedule. With RosterLab's open shift feature, you can instantly broadcast these available shifts to qualified staff members who can claim them through the mobile app, ensuring quick coverage without the manual phone calls or emails.",
  },
  {
    question: "How quickly can open shifts be filled?",
    answer:
      "With RosterLab's instant notification system, open shifts can be filled within minutes. As soon as you post an open shift, all qualified and available staff receive push notifications. The first suitable staff to accept gets the shift, and the schedule is automatically updated.",
  },
  {
    question: "How do staff know about open shifts?",
    answer:
      "Staff receive instant push notifications on their mobile devices when shifts matching their qualifications become available. They can also check the app proactively to see all open shifts they're eligible for.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "The shift is reopened and automatically shared with the staff who were originally offered it.",
  },
];
...
export default function OpenShiftsPage() {
  return (
    <SiteLayout>
            ...
            <div className="flex flex-col lg:grid lg:grid-cols-2 gap-12 items-center">
              <div className="w-full">
                ...
                <div className="block lg:hidden w-full relative mb-8">
                  <Image
                    src="/images/updated-hero/open-shifts.webp"
                ...
                <p className="text-xl text-gray-600 mb-8">
                  Share open shifts to qualified staff and fill gaps in minutes,
                  not hours.
                </p>
          ...
          <Container>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                <p className="text-lg text-gray-600 mb-6">
                  When open shifts are filled, the schedule updates
                  automatically and notifies the admin in real time. This
                  removes the need for manual edits, speeds up the scheduling
                  process, and keeps everyone on the same page, reducing
                  miscommunication and ensuring staffing levels are always
                  accurate.
                </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-6">
                  ...
                  is already scheduled for. Managers can choose to invite staff
                  who already have a shift with the option to replace their
                  existing shift with a higher priority shift.
                </p>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <HiCheck className="w-6 h-6 text-teal-600 mr-3 mt-0.5 flex-shrink-0" />
          ...
          <Container>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                <p className="text-lg text-gray-600 mb-6">
                  Staff see available shifts in real-time and can claim them
                ...
                <ul className="space-y-4">
                  ...
                  <li className="flex items-start">
                    <HiCheck className="w-6 h-6 text-teal-600 mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">
                      Automatic scheduling when shifts are filled
                    </span>
                  </li>
                </ul>
              </div>
      ...
      <BreadcrumbSchema
        items={[{ name: "Home", url: "/us" }, { name: "Open Shifts" }]}
      />
    </SiteLayout>
  );
}
