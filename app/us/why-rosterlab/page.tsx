...
export const metadata = withHreflang(
  {
    title: "Why Teams Choose Us for Staff Scheduling",
    description:
      "Discover why teams choose RosterLab as their scheduling platform. Our team is dedicated to building smarter, fairer AI scheduling tools that put people first.",
    alternates: {
      canonical: "https://rosterlab.com/us/why-rosterlab",
    },
    other: {
    ...
    openGraph: {
      ...
      description:
        "Discover why teams choose RosterLab as their scheduling platform. Our team is dedicated to building smarter, fairer AI scheduling tools that put people first.",
      type: "website",
      url: "https://rosterlab.com/us/why-rosterlab",
      images: [
        {
...
export default async function WhyRosterLabPage() {
  ...
  return (
    <SiteLayout>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                ...
                we make scheduling smarter, faster, and effortless.
              </p>
        ...
        <Container>
          <div className="max-w-6xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">
              Schedules Solved in Minutes, Not Days.
            </h2>
      ...
      <div className="bg-white py-20">
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Purpose-Built AI Optimization
              </h2>
              <p className="text-lg text-gray-600 mb-6">
                RosterLab is an optimization solver dedicated for workforce
              ...
              <ul className="text-lg text-gray-600 space-y-3">
                <li className="flex items-start">
                  ...
                  <span>Optimize for safe staffing levels for every shift</span>
                </li>
                <li className="flex items-start">
                  <svg
                    className="w-6 h-6 text-green-600 mr-3 flex-shrink-0 mt-0.5"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-lg p-6 shadow-sm text-center">
                ...
                <p className="text-gray-600">
                  From building your first schedule with RosterLab, you'll
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm text-center">
                ...
                <p className="text-gray-600">
                  Maintain your scheduling approach while reducing admin for an
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm text-center">
                ...
                <p className="text-gray-600">
                  Personalized rules for roles and skills make it easy to scale
            ...
            <div>
              <div className="bg-white rounded-xl shadow-lg p-8">
                ...
                <blockquote className="text-lg text-gray-700 leading-relaxed mb-4">
                  ...
                  schedule automatically, but you can also switch schedule views
                  by employee and by shift, making it easier to manage - that is
        ...
        <Container>
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-12">
              Our AI Scheduling Assistant (Otto) will soon be able to take
              action on your behalf, making scheduling effortless - always with
        ...
        <Container>
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-center text-gray-600 mb-12 text-lg">
              Common questions about our AI-powered scheduling technology
            </p>
            <FAQAccordion
              items={[
                {
                ...
                },
                {
                  ...
                  answer:
                    "RosterLab uses mathematical optimization (operations research) to build and solve schedules. The AI applies mathematical, statistical, and computational methods to help make better scheduling decisions - especially for complex ones involving limited resources, risks, and trade-offs.",
                },
                {
      ...
      <BreadcrumbSchema
        items={[{ name: "Home", url: "/us" }, { name: "Why Choose Us" }]}
      />
    </SiteLayout>
  );
}
