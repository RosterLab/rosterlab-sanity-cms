...
export default function SchedulingGenerator() {
    ...
    >
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4 relative">
        ...
        <p className="text-sm text-blue-100 mt-1 mb-0 sm:mb-0 pb-6 sm:pb-0">
          Automated scheduling with all requirements optimized
        </p>
      </div>
        ...
        <div className="flex gap-3">
          {!isGenerating && progress !== 100 ? (
            ...
            >
              ...
              Generate Medical Staff Schedule
            </button>
          ) : isGenerating ? (
            <button
              disabled
            ...
            <>
              <Link href="/us/book-a-demo" className="flex-1">
        ...
        {isGenerating && (
          <div className="mt-4 space-y-2">
            ...
            >
              ...
              ></div>
              <span>Optimizing staffing coverage</span>
            </div>
            <div
