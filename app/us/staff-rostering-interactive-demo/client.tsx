...
export default function StaffSchedulingInteractiveDemoClient() {
      ...
      <Container>
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-neutral-600 max-w-3xl mx-auto mb-8">
            Discover how our AI-powered scheduling platform can save your healthcare team 90% of scheduling time 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
            ...
            <p className="text-green-700 text-sm">Generate schedules in minutes, not hours</p>
          </div>
          ...
          <div className="bg-purple-50 border border-purple-200 rounded-lg p-6 text-center">
            ...
            <p className="text-purple-700 text-sm">Fairer, safer schedules for your team</p>
          </div>
        </div>
