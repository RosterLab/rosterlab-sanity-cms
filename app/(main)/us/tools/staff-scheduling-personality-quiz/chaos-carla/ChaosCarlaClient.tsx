...
export default function ChaosCarlaClient({ recommendedPosts }: ChaosCarlaClientProps) {
  ...
  const generatePDF = useCallback(async () => {
    try {
      ...
      doc.link(28, currentY - 3, blog2Width, 4, {url: 'https://rosterlab.com/us/blog/how-to-reduce-absenteeism-for-shift-workers'})
      currentY += 8
      ...
      doc.link(28, currentY - 3, blog3Width, 4, {url: 'https://rosterlab.com/us/blog/scheduling-basics'})
      currentY += 17
