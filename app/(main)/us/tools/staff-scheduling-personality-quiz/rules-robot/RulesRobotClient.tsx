...
export default function RulesRobotClient({ recommendedPosts }: RulesRobotClientProps) {
  ...
  const generatePDF = useCallback(async () => {
    try {
      ...
      doc.setFontSize(11)
      doc.setTextColor(...textColor as [number, number, number])
      const description = "You're the guardian of compliance, the protector of protocols. Your schedule isn't just a schedule—it's a legally sound document that could withstand any audit."
      ...
      doc.setFont('helvetica', 'normal')
      doc.setFontSize(10)
      doc.text('  Serves up schedules with precision', 25, currentY + 5)
      currentY += 12
      
      // Celebrity 2 text
      doc.setFont('helvetica', 'bold')
      doc.setFontSize(11)
      doc.text('• Dwayne "The Schedule" Johnson', 25, currentY)
      doc.setFont('helvetica', 'normal')
      doc.setFontSize(10)
      ...
      doc.setTextColor(...textColor as [number, number, number])
      doc.text(': Generate compliant schedules in seconds', 28 + tool3Width, currentY)
      currentY += 8
      ...
      doc.link(28, currentY - 3, blog1Width, 4, {url: 'https://rosterlab.com/us/blog/manage-night-shift-planning-wellbeing-effectively'})
      currentY += 8
      ...
      doc.link(28, currentY - 3, blog2Width, 4, {url: 'https://rosterlab.com/us/blog/fairer-scheduling-at-work-reducing-shift-bias'})
      currentY += 8
      ...
      doc.text('• ', 25, currentY)
      doc.setTextColor(...linkBlue as [number, number, number])
      const blog3Text = 'Staff Scheduling to Payroll: The Right Way to Do It'
      const blog3Width = doc.getTextWidth(blog3Text)
      doc.text(blog3Text, 28, currentY)
      doc.link(28, currentY - 3, blog3Width, 4, {url: 'https://rosterlab.com/us/blog/staff-scheduling-to-payroll-the-right-way-to-do-it'})
      currentY += 17
          ...
          <div className="grid gap-8 md:grid-cols-3 mt-16">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 max-w-xs mx-auto">
                Serves up schedules with precision and zero tolerance for rule violations.
              </p>
            </div>
            ...
            <div className="text-center">
              <div className="w-48 h-48 mx-auto mb-6 rounded-full bg-gray-200 flex items-center justify-center overflow-hidden">
                <Image
                  ...
                  alt="Dwayne The Schedule Johnson"
                  width={192}
                  height={192}
                  className="w-full h-full object-cover"
                  priority
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Dwayne "The Schedule" Johnson</h3>
              <p className="text-gray-600 max-w-xs mx-auto">
      ...
      <section id="as-rules-robot-section" className="relative z-30 py-8 md:py-10 lg:py-12 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-gray-600 mb-12 text-center max-w-4xl mx-auto">
            You navigate the complex world of staff scheduling with precision and an unwavering commitment to compliance. Your methodical approach ensures every schedule is legally sound and audit-ready.
          </p>
          ...
          <div className="grid gap-8 md:grid-cols-3 mb-12">
            <Link href="/us/solutions/staff-scheduling-mobile-app" className="block">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-lg h-full">
                ...
                <p className="text-gray-600 mb-4">
                  Empower your team with mobile access to schedules, shift swaps, and leave requests - all compliant with your rules.
                </p>
            ...
            <Link href="/us/solutions/ai-staff-scheduling" className="block">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-lg h-full">
                ...
                <p className="text-gray-600 mb-4">
                  Generate compliant schedules in seconds with AI that understands and enforces all your rules and requirements.
                </p>
                <span className="text-primary-600 font-medium inline-flex items-center">
                  Learn more 
                  <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
