...
export const metadata: Metadata = {
  ...
  description: 'Master of formulas and pivot tables. Discover your scheduling personality and learn how to leverage your data-driven approach to create perfectly optimized staff schedules.',
  robots: {
    index: false,
    follow: true
  },
