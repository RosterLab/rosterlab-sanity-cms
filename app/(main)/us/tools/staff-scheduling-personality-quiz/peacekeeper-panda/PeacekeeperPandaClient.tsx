...
export default function PeacekeeperPandaClient({ recommendedPosts }: PeacekeeperPandaClientProps) {
  ...
  const generatePDF = useCallback(async () => {
    try {
      ...
      doc.link(28, currentY - 3, tool2Width, 4, {url: 'https://rosterlab.com/us/feature/self-scheduling'})
      doc.setTextColor(...textColor as [number, number, number])
      doc.text(': Let teams collaborate on their ideal schedules', 28 + tool2Width, currentY)
      currentY += 8
      
      // Tool 3: Automation schedule generation
      doc.setTextColor(...textColor as [number, number, number])
      doc.text('• ', 25, currentY)
      doc.setTextColor(...linkBlue as [number, number, number])
      ...
      doc.setTextColor(...textColor as [number, number, number])
      doc.text(': Create balanced schedules automatically', 28 + tool3Width, currentY)
      currentY += 8
      ...
      doc.link(28, currentY - 3, blog1Width, 4, {url: 'https://rosterlab.com/us/blog/increase-staff-engagement-for-shift-workers'})
      currentY += 8
      ...
      doc.link(28, currentY - 3, blog2Width, 4, {url: 'https://rosterlab.com/us/blog/skeleton-staffing-guide-lean-operations-management'})
      currentY += 8
      ...
      doc.link(28, currentY - 3, blog3Width, 4, {url: 'https://rosterlab.com/us/blog/fairer-scheduling-at-work-reducing-shift-bias'})
      currentY += 17
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full">
          ...
          <div className="grid gap-8 md:grid-cols-3 mt-16">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Sir Schedule Attenborough</h3>
              <p className="text-gray-600 max-w-xs mx-auto">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Zendaya Zen-schedule</h3>
              <p className="text-gray-600 max-w-xs mx-auto">
          ...
          <div className="grid gap-8 md:grid-cols-3 mb-12">
            ...
            <Link href="/us/solutions/ai-staff-scheduling" className="block">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-lg h-full">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Automation Schedule Generation</h3>
                <p className="text-gray-600 mb-4">
                  Create balanced schedules automatically that consider everyone's needs and preferences.
                </p>
                <span className="text-primary-600 font-medium inline-flex items-center">
                  Learn more 
                  <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
