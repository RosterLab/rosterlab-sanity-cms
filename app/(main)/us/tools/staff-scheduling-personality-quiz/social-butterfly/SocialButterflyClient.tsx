...
export default function SocialButterflyClient({ recommendedPosts }: SocialButterflyClientProps) {
  ...
  const generatePDF = useCallback(async () => {
    try {
      ...
      doc.setFontSize(10)
      doc.setTextColor(...textColor as [number, number, number])
      const butterflyDesc = 'You create schedules that keep everyone happy, ensuring fairness while maintaining team morale and positive workplace vibes.'
      ...
      doc.setTextColor(...textColor as [number, number, number])
      doc.text(': Create fair schedules that consider team preferences', 28 + tool3Width, currentY)
      currentY += 8
      ...
      doc.link(28, currentY - 3, blog2Width, 4, {url: 'https://rosterlab.com/us/blog/comprehensive-guide-shift-swaps'})
      currentY += 8
      ...
      doc.link(28, currentY - 3, blog3Width, 4, {url: 'https://rosterlab.com/us/blog/rotating-schedules'})
      currentY += 17
      ...
      <section id="as-social-butterfly-section" className="relative z-30 py-8 md:py-10 lg:py-12 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-gray-600 mb-12 text-center max-w-4xl mx-auto">
            You create schedules that keep everyone happy, ensuring fairness while maintaining team morale and positive workplace vibes. Your empathetic approach makes you the heart of your scheduling team.
          </p>
          ...
          <div className="grid gap-8 md:grid-cols-3 mb-12">
            ...
            <Link href="/us/solutions/staff-schedule-mobile-app" className="block">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-lg h-full">
                ...
                <p className="text-gray-600 mb-4">
                  Keep everyone connected and engaged on the go with real-time schedule updates and team communication.
                </p>
                <span className="text-primary-600 font-medium inline-flex items-center">
                  Learn more 
                  <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link href="/us/solutions/ai-staff-scheduling" className="block">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-lg h-full">
                ...
                <p className="text-gray-600 mb-4">
                  Create fair schedules that consider team preferences and maintain harmony automatically.
                </p>
                <span className="text-primary-600 font-medium inline-flex items-center">
                  Learn more 
                  <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
