...
import ChaosNancyClient from './ChaosNancyClient'
import { Metadata } from 'next'

export const metadata: Metadata = {
  title: 'Chaos Nancy - Your Rostering Personality',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'RosterLab Personality Quiz - Chaos Nancy'
      }
    ],
    type: 'website',
    url: '/tools/staff-scheduling-personality-quiz/chaos-nancy'
  },
  twitter: {
...
export default async function ChaosNancyPage() {
  ...
  return <ChaosNancyClient recommendedPosts={recommendedPosts} />
}