...
const painPoints = [
  {
    ...
    description:
      "Multiple versions, lost updates, and formula errors making scheduling a nightmare. Move to digital rostering - it's free forever.",
  },
  {
    title: "Free Forever",
    description:
      "No hidden fees, no credit card required. Get started with digital rostering at no cost and stay free forever.",
  },
  {
