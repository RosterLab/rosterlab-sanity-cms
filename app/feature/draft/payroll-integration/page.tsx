...
const faqItems = [
  {
    ...
    answer:
      "RosterLab can create integrations with most major payroll systems including ADP, Paychex, Workday, SAP, Oracle, and many others. We support multiple integration methods including API sync and file exports (CSV, Excel, XML).",
  },
  {
    question: "Can I review timesheet data before it goes to payroll?",
    answer:
      "Yes! RosterLab includes a comprehensive approval workflow. Managers can review and approve timesheets before they're sent to payroll.",
  },
  {
    question: "What happens if there's a sync error?",
    answer:
      "Our system includes comprehensive error handling and recovery. If a sync fails, you'll receive a notification. Our <a href='/contact' class='text-green-600 hover:text-green-700 underline'>support team</a> is available 24/7 to help resolve any integration issues quickly.",
  },
];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-xl text-gray-600 mb-8">
                  Get your roster and payroll talking to each other with our
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-6">
                  Export roster and timesheet data in multiple formats
                  compatible with your payroll system. Upload directly to ensure
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-700">
                      Multiple export formats (CSV, Excel, XML, JSON)
                    </span>
                  </li>
                  <li className="flex items-start">
                    <HiCheck className="w-6 h-6 text-[#4a9288] mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">
                      Automated file transfers via our API
                    </span>
                  </li>
                  <li className="flex items-start">
                    <HiCheck className="w-6 h-6 text-[#4a9288] mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">
                      Custom field mapping for any payroll system
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <Container>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                      ...
                      <div className="flex flex-col items-center justify-center">
                        ...
                        <div className="bg-green-50 rounded-lg p-3 border border-green-200 w-full max-w-xs mb-6">
                          ...
                          <div className="space-y-1">
                            <div className="bg-white rounded px-2 py-1 text-xs text-gray-600 font-mono">
                              roster_data.json
                            </div>
                            <div className="bg-white rounded px-2 py-1 text-xs text-gray-600 font-mono">
                              timesheets.csv
                        ...
                        <div className="relative w-full max-w-xs h-14 mb-6">
                          ...
                          <div className="absolute left-1/4 top-0 transform -translate-x-1/2">
                            <svg
                              className="w-6 h-14 text-green-600"
                              fill="none"
                              stroke="currentColor"
                              viewBox="0 0 24 24"
                            >
                          ...
                          <div className="absolute right-1/4 top-0 transform translate-x-1/2">
                            <svg
                              className="w-6 h-14 text-blue-600"
                              fill="none"
                              stroke="currentColor"
                              viewBox="0 0 24 24"
                            >
              ...
              <div className="order-1 lg:order-2">
                ...
                <p className="text-lg text-gray-600 mb-6">
                  Real-time data synchronization between RosterLab and your
                  payroll system. Ensure accuracy and stay up-to-date with
                  automatic two-way data flow and conflict resolution.
                </p>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <HiCheck className="w-6 h-6 text-[#4a9288] mr-3 mt-0.5 flex-shrink-0" />
          ...
          <Container>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-6">
                  Generate secure, shareable links to live roster data that your
                  payroll team can access directly. Always up-to-date
                  information without manual file transfers or outdated data.
                </p>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <HiCheck className="w-6 h-6 text-[#4a9288] mr-3 mt-0.5 flex-shrink-0" />
                  ...
                  <li className="flex items-start">
                    <HiCheck className="w-6 h-6 text-[#4a9288] mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">
                      Real-time roster data always current
                    </span>
                  </li>
                  <li className="flex items-start">
                    <HiCheck className="w-6 h-6 text-[#4a9288] mr-3 mt-0.5 flex-shrink-0" />
          ...
          <Container>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                <p className="text-lg text-gray-600 mb-6">
                  Intelligent timesheet generation based on actual roster data.
                  Approve timesheets in bulk, handle exceptions efficiently,
                  then export clean data for payroll processing.
                </p>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <HiCheck className="w-6 h-6 text-[#4a9288] mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">
                      Auto-generated timesheets from roster data
                    </span>
                  </li>
                  <li className="flex items-start">
                    <HiCheck className="w-6 h-6 text-[#4a9288] mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">
                      Bulk approval and exception handling
                    </span>
                  </li>
                  <li className="flex items-start">
                    <HiCheck className="w-6 h-6 text-[#4a9288] mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">
                      Overtime calculations and pay rate handling
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <Container>
            <div className="text-center bg-white rounded-3xl shadow-xl p-12">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
                Eliminate manual data entry and ensure payroll accuracy with
                seamless integration between your roster and payroll systems.
              </p>
